...
* generated by Xtext
*/
package de.bmw.carit.xspec.ui.contentassist.antlr;
...
public class XSpecParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.bmw.carit.xspec.ui.contentassist.antlr.internal.InternalXSpecParser createParser() {
		de.bmw.carit.xspec.ui.contentassist.antlr.internal.InternalXSpecParser result = new de.bmw.carit.xspec.ui.contentassist.antlr.internal.InternalXSpecParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXSpecAccess().getGroup(), "rule__XSpec__Group__0");
					...
					put(grammarAccess.getXSpecAccess().getModuleNameAssignment_0(), "rule__XSpec__ModuleNameAssignment_0");
					put(grammarAccess.getXSpecAccess().getSpecsAssignment_2(), "rule__XSpec__SpecsAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.bmw.carit.xspec.ui.contentassist.antlr.internal.InternalXSpecParser typedParser = (de.bmw.carit.xspec.ui.contentassist.antlr.internal.InternalXSpecParser) parser;
			typedParser.entryRuleXSpec();
