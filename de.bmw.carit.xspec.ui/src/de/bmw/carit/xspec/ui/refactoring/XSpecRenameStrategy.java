...
* generated by Xtext
*/
package de.bmw.carit.xspec.ui.refactoring;
 ...
 */
public class XSpecRenameStrategy extends AbstractJvmModelRenameStrategy {
	...
	public static class Provider extends DefaultRenameStrategy.Provider {
		...
		public IRenameStrategy get(EObject targetElement, IRenameElementContext renameElementContext) {
			return new XSpecRenameStrategy(targetElement, getLocationInFileProvider(), jvmModelAssociations);
		}
	}
	
	protected XSpecRenameStrategy(EObject targetElement, ILocationInFileProvider locationInFileProvider,
