 ...
 *   <li>{@link de.bmw.carit.jnario.jnario.impl.JnarioImpl#getDescription <em>Description</em>}</li>
...
public class JnarioImpl extends XtendFileImplCustom implements Jnario
{
	...
	public void setDescription(String newDescription)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JnarioPackage.JNARIO__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case JnarioPackage.JNARIO__NAME:
				return getName();
			case JnarioPackage.JNARIO__DESCRIPTION:
