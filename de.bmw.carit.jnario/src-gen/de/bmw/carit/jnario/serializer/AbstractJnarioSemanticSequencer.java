...
public class AbstractJnarioSemanticSequencer extends AbstractSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == JnarioPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case JnarioPackage.GIVEN:
				if(context == grammarAccess.getStepRule() ||
				   context == grammarAccess.getGivenRule()) {
					sequence_Given_Given(context, (Given) semanticObject); 
					return; 
				}
				else break;
			case JnarioPackage.JNARIO:
				if(context == grammarAccess.getJnarioRule()) {
					sequence_Jnario_Jnario(context, (Jnario) semanticObject); 
					return; 
				}
				else break;
			...
			case JnarioPackage.SENTENCE:
				if(context == grammarAccess.getSentenceRule()) {
					sequence_Sentence_Sentence(context, (Sentence) semanticObject); 
					return; 
				}
				else break;
			case JnarioPackage.THEN:
				if(context == grammarAccess.getStepRule() ||
				   context == grammarAccess.getThenRule()) {
					sequence_Then_Then(context, (Then) semanticObject); 
					return; 
				}
				else break;
			case JnarioPackage.WHEN:
				if(context == grammarAccess.getStepRule() ||
				   context == grammarAccess.getWhenRule()) {
					sequence_When_When(context, (When) semanticObject); 
					return; 
				}
				else break;
			}
			...
			case XbasePackage.XBLOCK_EXPRESSION:
				...
				else if(context == grammarAccess.getCodeRule()) {
					sequence_Code_XBlockExpression(context, (XBlockExpression) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *    expressions[1, *]
	 */
	protected void sequence_Code_XBlockExpression(EObject context, XBlockExpression semanticObject) {
	 ...
	 *    code[0, 1]
	 */
	protected void sequence_Given_Given(EObject context, Given semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *    scenarios[1, *]
	 */
	protected void sequence_Jnario_Jnario(EObject context, Jnario semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Scenario_Scenario(EObject context, Scenario semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, JnarioPackage.Literals.SCENARIO__SCENARIO_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JnarioPackage.Literals.SCENARIO__SCENARIO_NAME));
			if(transientValues.isValueTransient(semanticObject, JnarioPackage.Literals.SCENARIO__SPEC) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JnarioPackage.Literals.SCENARIO__SPEC));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getScenarioAccess().getScenarioNameSCENARIO_TEXTTerminalRuleCall_0_0(), semanticObject.getScenarioName());
		feeder.accept(grammarAccess.getScenarioAccess().getSpecSentenceParserRuleCall_1_0(), semanticObject.getSpec());
		feeder.finish();
	}
	 ...
	 *    then[1, 1]
	 */
	protected void sequence_Sentence_Sentence(EObject context, Sentence semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, JnarioPackage.Literals.SENTENCE__GIVEN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JnarioPackage.Literals.SENTENCE__GIVEN));
			if(transientValues.isValueTransient(semanticObject, JnarioPackage.Literals.SENTENCE__WHEN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JnarioPackage.Literals.SENTENCE__WHEN));
			if(transientValues.isValueTransient(semanticObject, JnarioPackage.Literals.SENTENCE__THEN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JnarioPackage.Literals.SENTENCE__THEN));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getSentenceAccess().getGivenGivenParserRuleCall_0_0(), semanticObject.getGiven());
		feeder.accept(grammarAccess.getSentenceAccess().getWhenWhenParserRuleCall_1_0(), semanticObject.getWhen());
		feeder.accept(grammarAccess.getSentenceAccess().getThenThenParserRuleCall_2_0(), semanticObject.getThen());
		feeder.finish();
	}
	 ...
	 *    code[0, 1]
	 */
	protected void sequence_Then_Then(EObject context, Then semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *    code[0, 1]
	 */
	protected void sequence_When_When(EObject context, When semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
