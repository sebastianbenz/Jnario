		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFieldAccess().getRightAssignment_3_1(), "rule__Field__RightAssignment_3_1");
					put(grammarAccess.getExampleAccess().getPreambleAssignment_1(), "rule__Example__PreambleAssignment_1");
					put(grammarAccess.getExampleAccess().getFeatureAssignment_2(), "rule__Example__FeatureAssignment_2");
					put(grammarAccess.getExampleAccess().getNameAssignment_3(), "rule__Example__NameAssignment_3");
					put(grammarAccess.getExampleAccess().getBodyAssignment_4(), "rule__Example__BodyAssignment_4");
