...
:
(
{ before(grammarAccess.getMemberAccess().getNameSTRINGTerminalRuleCall_2_5_1_1_0()); }
	RULE_STRING{ after(grammarAccess.getMemberAccess().getNameSTRINGTerminalRuleCall_2_5_1_1_0()); }
)
