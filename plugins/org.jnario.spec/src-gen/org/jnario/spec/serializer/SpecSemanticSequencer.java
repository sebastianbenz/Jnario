...
public class SpecSemanticSequencer extends XtendSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == JnarioPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XtendPackage.XTEND_MEMBER:
				if(context == grammarAccess.getAnnotationFieldAccess().getXtendAnnotationTypeAnnotationInfoAction_2_4_0() ||
				...
				else if(context == grammarAccess.getMemberAccess().getAfterAnnotationInfoAction_2_3_0() ||
				   ...
				   context == grammarAccess.getMemberAccess().getXtendFunctionAnnotationInfoAction_2_7_0()) {
					sequence_Member_After_2_3_0_Before_2_2_0_ExampleGroup_2_1_0_ExampleGroup_2_4_0_ExampleTable_2_5_0_Example_2_0_0_XtendField_2_6_0_XtendFunction_2_7_0(context, (XtendMember) semanticObject); 
					return; 
				}
				else break;
			...
			case XtendPackage.XTEND_TYPE_DECLARATION:
				if(context == grammarAccess.getTypeAccess().getExampleGroupAnnotationInfoAction_2_4_0() ||
				   ...
				   context == grammarAccess.getTypeAccess().getXtendInterfaceAnnotationInfoAction_2_1_0()) {
					sequence_Type_ExampleGroup_2_4_0_XtendAnnotationType_2_3_0_XtendClass_2_0_0_XtendEnum_2_2_0_XtendInterface_2_1_0(context, (XtendTypeDeclaration) semanticObject); 
					return; 
				}
				else break;
	 ...
	 */
	protected void sequence_Member_After_2_3_0_Before_2_2_0_ExampleGroup_2_1_0_ExampleGroup_2_4_0_ExampleTable_2_5_0_Example_2_0_0_XtendField_2_6_0_XtendFunction_2_7_0(EObject context, XtendMember semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     (
	 *         (
	 *             (annotationInfo=Member_XtendFunction_2_7_0 modifiers+=CommonModifier* modifiers+=MethodModifier) | 
	 *             (annotationInfo=Member_XtendFunction_2_7_0 modifiers+=MethodModifier)
	 *         ) 
	...
	/**
	 * Constraint:
	 *     (annotationInfo=Type_ExampleGroup_2_4_0 preamble='describe' targetType=JvmTypeReference? name=STRING? members+=Member*)
	 */
	 ...
	 *     annotations+=XAnnotation+
	 */
	protected void sequence_Type_ExampleGroup_2_4_0_XtendAnnotationType_2_3_0_XtendClass_2_0_0_XtendEnum_2_2_0_XtendInterface_2_1_0(EObject context, XtendTypeDeclaration semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     (
	 *         (
	 *             (annotationInfo=Type_XtendAnnotationType_2_3_0 modifiers+=CommonModifier* name=ValidID) | 
	 ...
	 * Constraint:
	 *     (
	 *         ((annotationInfo=Type_XtendEnum_2_2_0 modifiers+=CommonModifier* name=ValidID) | (annotationInfo=Type_XtendEnum_2_2_0 name=ValidID)) 
