		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSuiteFileAccess().getImportsAssignment_2(), "rule__SuiteFile__ImportsAssignment_2");
					put(grammarAccess.getSuiteFileAccess().getXtendClassesAssignment_3(), "rule__SuiteFile__XtendClassesAssignment_3");
