...
public class SuiteSemanticSequencer extends XtendSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == SuitePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case SuitePackage.SUITE:
				if(context == grammarAccess.getSuiteRule()) {
					sequence_Suite(context, (Suite) semanticObject); 
					return; 
				}
				else break;
			case SuitePackage.SUITE_FILE:
				if(context == grammarAccess.getSuiteFileRule()) {
					sequence_SuiteFile(context, (SuiteFile) semanticObject); 
					return; 
				}
				else break;
			}
			...
			case XtypePackage.XIMPORT_DECLARATION:
				if(context == grammarAccess.getImportRule()) {
					sequence_Import(context, (XImportDeclaration) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getXImportDeclarationRule()) {
	 ...
	 */
	protected void sequence_Import(EObject context, XImportDeclaration semanticObject) {
	 ...
	 *     pattern=PATTERN
	 */
	protected void sequence_PatternReference(EObject context, PatternReference semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, SuitePackage.Literals.PATTERN_REFERENCE__PATTERN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SuitePackage.Literals.PATTERN_REFERENCE__PATTERN));
		}
	...
	/**
	 * Constraint:
	 *     (spec=[Specification|STRING] text=TEXT?)
	 */
	protected void sequence_SpecReference(EObject context, SpecReference semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (package=QualifiedName? importSection=XImportSection? xtendTypes+=Suite*)
	 */
	protected void sequence_SuiteFile(EObject context, SuiteFile semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
