...
* generated by Xtext
*/
parser grammar InternalSpecParser;

options {
	tokenVocab=InternalSpecLexer;
...
@members {
 	...
 	
 	{
		...
		tokenNameToValue.put("KEYWORD_40", "'IF'");
		tokenNameToValue.put("KEYWORD_41", "'as'");
		tokenNameToValue.put("KEYWORD_42", "'do'");
		tokenNameToValue.put("KEYWORD_43", "'if'");
		tokenNameToValue.put("KEYWORD_44", "'||'");
		tokenNameToValue.put("KEYWORD_45", "'!=='");
		...
		tokenNameToValue.put("KEYWORD_50", "'FOR'");
		tokenNameToValue.put("KEYWORD_51", "'all'");
		tokenNameToValue.put("KEYWORD_52", "'def'");
		tokenNameToValue.put("KEYWORD_53", "'for'");
		tokenNameToValue.put("KEYWORD_54", "'new'");
		tokenNameToValue.put("KEYWORD_55", "'not'");
		tokenNameToValue.put("KEYWORD_56", "'try'");
		tokenNameToValue.put("KEYWORD_57", "'val'");
		tokenNameToValue.put("KEYWORD_58", "'var'");
		tokenNameToValue.put("KEYWORD_59", "'ELSE'");
		tokenNameToValue.put("KEYWORD_60", "'case'");
		tokenNameToValue.put("KEYWORD_61", "'each'");
		tokenNameToValue.put("KEYWORD_62", "'else'");
		tokenNameToValue.put("KEYWORD_63", "'enum'");
		tokenNameToValue.put("KEYWORD_64", "'fact'");
		tokenNameToValue.put("KEYWORD_65", "'null'");
		tokenNameToValue.put("KEYWORD_66", "'true'");
		tokenNameToValue.put("KEYWORD_67", "'AFTER'");
		tokenNameToValue.put("KEYWORD_68", "'ENDIF'");
		tokenNameToValue.put("KEYWORD_69", "'after'");
		tokenNameToValue.put("KEYWORD_70", "'catch'");
		tokenNameToValue.put("KEYWORD_71", "'class'");
		tokenNameToValue.put("KEYWORD_72", "'facts'");
		tokenNameToValue.put("KEYWORD_73", "'false'");
		tokenNameToValue.put("KEYWORD_74", "'final'");
		tokenNameToValue.put("KEYWORD_75", "'super'");
		tokenNameToValue.put("KEYWORD_76", "'throw'");
		tokenNameToValue.put("KEYWORD_77", "'while'");
		tokenNameToValue.put("KEYWORD_78", "'BEFORE'");
		tokenNameToValue.put("KEYWORD_79", "'ELSEIF'");
		tokenNameToValue.put("KEYWORD_80", "'ENDFOR'");
		tokenNameToValue.put("KEYWORD_81", "'assert'");
		tokenNameToValue.put("KEYWORD_82", "'before'");
		tokenNameToValue.put("KEYWORD_83", "'create'");
		tokenNameToValue.put("KEYWORD_84", "'import'");
		tokenNameToValue.put("KEYWORD_85", "'native'");
		tokenNameToValue.put("KEYWORD_86", "'public'");
		tokenNameToValue.put("KEYWORD_87", "'return'");
		tokenNameToValue.put("KEYWORD_88", "'should'");
		tokenNameToValue.put("KEYWORD_89", "'static'");
		tokenNameToValue.put("KEYWORD_90", "'switch'");
		tokenNameToValue.put("KEYWORD_91", "'throws'");
		tokenNameToValue.put("KEYWORD_92", "'typeof'");
		tokenNameToValue.put("KEYWORD_93", "'context'");
		tokenNameToValue.put("KEYWORD_94", "'default'");
		tokenNameToValue.put("KEYWORD_95", "'extends'");
		tokenNameToValue.put("KEYWORD_96", "'finally'");
		tokenNameToValue.put("KEYWORD_97", "'package'");
		tokenNameToValue.put("KEYWORD_98", "'pending'");
		tokenNameToValue.put("KEYWORD_99", "'private'");
		tokenNameToValue.put("KEYWORD_100", "'abstract'");
		tokenNameToValue.put("KEYWORD_101", "'describe'");
		tokenNameToValue.put("KEYWORD_102", "'dispatch'");
		tokenNameToValue.put("KEYWORD_103", "'override'");
		tokenNameToValue.put("KEYWORD_104", "'strictfp'");
		tokenNameToValue.put("KEYWORD_105", "'volatile'");
		tokenNameToValue.put("KEYWORD_106", "'SEPARATOR'");
		tokenNameToValue.put("KEYWORD_107", "'extension'");
		tokenNameToValue.put("KEYWORD_108", "'interface'");
		tokenNameToValue.put("KEYWORD_109", "'protected'");
		tokenNameToValue.put("KEYWORD_110", "'transient'");
		tokenNameToValue.put("KEYWORD_111", "'annotation'");
		tokenNameToValue.put("KEYWORD_112", "'implements'");
		tokenNameToValue.put("KEYWORD_113", "'instanceof'");
		tokenNameToValue.put("KEYWORD_114", "'synchronized'");
 	}
...
ruleExampleCell 
    ...
    :
(
{ before(grammarAccess.getExampleCellAccess().getExpressionAssignment()); }
(rule__ExampleCell__ExpressionAssignment)
{ after(grammarAccess.getExampleCellAccess().getExpressionAssignment()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getFactKeyword_2_0_1_1_0()); }

	KEYWORD_64 

{ after(grammarAccess.getMemberAccess().getFactKeyword_2_0_1_1_0()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getFactsKeyword_2_0_1_1_1()); }

	KEYWORD_72 

{ after(grammarAccess.getMemberAccess().getFactsKeyword_2_0_1_1_1()); }
)
...
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_2_1_1_0()); }
    ...
    |(
{ before(grammarAccess.getMemberAccess().getEachKeyword_2_2_1_1_1()); }

	KEYWORD_61 

{ after(grammarAccess.getMemberAccess().getEachKeyword_2_2_1_1_1()); }
)
...
rule__Member__Alternatives_2_3_1_1
    @init {
		int stackSize = keepStackSize();
    }
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_3_1_1_0()); }
(rule__Member__ModifiersAssignment_2_3_1_1_0)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_3_1_1_0()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getEachKeyword_2_3_1_1_1()); }

	KEYWORD_61 

{ after(grammarAccess.getMemberAccess().getEachKeyword_2_3_1_1_1()); }
)
...
{ after(grammarAccess.getMemberAccess().getGroup_2_6_2_1()); }
    ...
    |(
{ before(grammarAccess.getMemberAccess().getGroup_2_6_2_2()); }
(rule__Member__Group_2_6_2_2__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_6_2_2()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getGroup_2_6_2_3()); }
(rule__Member__Group_2_6_2_3__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_6_2_3()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_1_1_0()); }
(rule__Member__ModifiersAssignment_2_6_2_1_1_0)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_1_1_0()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_1_1_1()); }
(rule__Member__ModifiersAssignment_2_6_2_1_1_1)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_1_1_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_3_0()); }
(rule__Member__ModifiersAssignment_2_7_3_0)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_3_0()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_3_1()); }
(rule__Member__ModifiersAssignment_2_7_3_1)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_3_1()); }
)
...
rule__Member__Alternatives_2_7_5
    @init {
		int stackSize = keepStackSize();
    }
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_5_0()); }
(rule__Member__Group_2_7_5_0__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_7_5_0()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_5_1()); }
(rule__Member__Group_2_7_5_1__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_7_5_1()); }
)
...
{ after(grammarAccess.getMemberAccess().getGroup_2_7_5_2()); }
    ...
    |(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_5_3()); }
(rule__Member__Group_2_7_5_3__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_7_5_3()); }
)
...
rule__Member__Alternatives_2_7_9
    @init {
		int stackSize = keepStackSize();
    }
:
(
{ before(grammarAccess.getMemberAccess().getExpressionAssignment_2_7_9_0()); }
(rule__Member__ExpressionAssignment_2_7_9_0)
{ after(grammarAccess.getMemberAccess().getExpressionAssignment_2_7_9_0()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getExpressionAssignment_2_7_9_1()); }
(rule__Member__ExpressionAssignment_2_7_9_1)
{ after(grammarAccess.getMemberAccess().getExpressionAssignment_2_7_9_1()); }
)

    |(
{ before(grammarAccess.getMemberAccess().getSemicolonKeyword_2_7_9_2()); }

	KEYWORD_14 

{ after(grammarAccess.getMemberAccess().getSemicolonKeyword_2_7_9_2()); }
)
...
{ after(grammarAccess.getXAnnotationElementValueAccess().getXAnnotationParserRuleCall_0()); }
    ...
    |(
{ before(grammarAccess.getXAnnotationElementValueAccess().getGroup_1()); }
(rule__XAnnotationElementValue__Group_1__0)
{ after(grammarAccess.getXAnnotationElementValueAccess().getGroup_1()); }
)

    |(
{ before(grammarAccess.getXAnnotationElementValueAccess().getXExpressionParserRuleCall_2()); }
	ruleXExpression
{ after(grammarAccess.getXAnnotationElementValueAccess().getXExpressionParserRuleCall_2()); }
)
...
:
(
{ before(grammarAccess.getSpecFileAccess().getImportSectionAssignment_2()); }
(rule__SpecFile__ImportSectionAssignment_2)?
{ after(grammarAccess.getSpecFileAccess().getImportSectionAssignment_2()); }
)
...
:
(
{ before(grammarAccess.getSpecFileAccess().getXtendTypesAssignment_3()); }
(rule__SpecFile__XtendTypesAssignment_3)*
{ after(grammarAccess.getSpecFileAccess().getXtendTypesAssignment_3()); }
)
...
:
(
{ before(grammarAccess.getTypeNameAccess().getLeftSquareBracketKeyword_2_0()); }

	KEYWORD_20 

{ after(grammarAccess.getTypeNameAccess().getLeftSquareBracketKeyword_2_0()); }
)
...
:
(
{ before(grammarAccess.getTypeNameAccess().getRightSquareBracketKeyword_2_1()); }

	KEYWORD_21 

{ after(grammarAccess.getTypeNameAccess().getRightSquareBracketKeyword_2_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getPendingAssignment_2_0_1_0()); }
(rule__Member__PendingAssignment_2_0_1_0)?
{ after(grammarAccess.getMemberAccess().getPendingAssignment_2_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExprAssignment_2_0_1_2()); }
(rule__Member__ExprAssignment_2_0_1_2)
{ after(grammarAccess.getMemberAccess().getExprAssignment_2_0_1_2()); }
)
...
:
	rule__Member__Group_2_0_1__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionAssignment_2_0_1_3()); }
(rule__Member__ExpressionAssignment_2_0_1_3)?
{ after(grammarAccess.getMemberAccess().getExpressionAssignment_2_0_1_3()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionAssignment_2_2_1_3()); }
(rule__Member__ExpressionAssignment_2_2_1_3)
{ after(grammarAccess.getMemberAccess().getExpressionAssignment_2_2_1_3()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getAlternatives_2_3_1_1()); }
(rule__Member__Alternatives_2_3_1_1)?
{ after(grammarAccess.getMemberAccess().getAlternatives_2_3_1_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionAssignment_2_3_1_3()); }
(rule__Member__ExpressionAssignment_2_3_1_3)
{ after(grammarAccess.getMemberAccess().getExpressionAssignment_2_3_1_3()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getSemicolonKeyword_2_6_4()); }
(
	KEYWORD_14 
)?
{ after(grammarAccess.getMemberAccess().getSemicolonKeyword_2_6_4()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_0_0()); }
(rule__Member__ModifiersAssignment_2_6_2_0_0)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_0_1()); }
(rule__Member__ModifiersAssignment_2_6_2_0_1)*
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_0_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_0_2()); }
(rule__Member__TypeAssignment_2_6_2_0_2)?
{ after(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_0_2()); }
)
...
:
	rule__Member__Group_2_6_2_0__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_0_3()); }
(rule__Member__NameAssignment_2_6_2_0_3)
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_0_3()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_1_0()); }
(rule__Member__ModifiersAssignment_2_6_2_1_0)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getAlternatives_2_6_2_1_1()); }
(rule__Member__Alternatives_2_6_2_1_1)*
{ after(grammarAccess.getMemberAccess().getAlternatives_2_6_2_1_1()); }
)
...
:
	...
	rule__Member__Group_2_6_2_1__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_1_2()); }
(rule__Member__TypeAssignment_2_6_2_1_2)
{ after(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_1_2()); }
)
...
:
	rule__Member__Group_2_6_2_1__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_1_3()); }
(rule__Member__NameAssignment_2_6_2_1_3)?
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_1_3()); }
)
...
:
	...
	rule__Member__Group_2_6_2_2__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_0()); }
(rule__Member__ModifiersAssignment_2_6_2_2_0)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_0()); }
)
...
:
	rule__Member__Group_2_6_2_2__1__Impl
	rule__Member__Group_2_6_2_2__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_1()); }
(rule__Member__ModifiersAssignment_2_6_2_2_1)*
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_1()); }
)
...
:
	rule__Member__Group_2_6_2_2__2__Impl
	rule__Member__Group_2_6_2_2__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_2()); }
(rule__Member__ModifiersAssignment_2_6_2_2_2)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_2()); }
)
...
:
	...
	rule__Member__Group_2_6_2_2__4
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_3()); }
(rule__Member__ModifiersAssignment_2_6_2_2_3)*
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_6_2_2_3()); }
)
...
:
	...
	rule__Member__Group_2_6_2_2__5
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_2_4()); }
(rule__Member__TypeAssignment_2_6_2_2_4)
{ after(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_2_4()); }
)
...
:
	rule__Member__Group_2_6_2_2__5__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_2_5()); }
(rule__Member__NameAssignment_2_6_2_2_5)?
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_2_5()); }
)
...
:
	...
	rule__Member__Group_2_6_2_3__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_3_0()); }
(rule__Member__TypeAssignment_2_6_2_3_0)
{ after(grammarAccess.getMemberAccess().getTypeAssignment_2_6_2_3_0()); }
)
...
:
	rule__Member__Group_2_6_2_3__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_3_1()); }
(rule__Member__NameAssignment_2_6_2_3_1)
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_6_2_3_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_1()); }
(rule__Member__ModifiersAssignment_2_7_1)*
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_2()); }
(rule__Member__ModifiersAssignment_2_7_2)
{ after(grammarAccess.getMemberAccess().getModifiersAssignment_2_7_2()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getAlternatives_2_7_3()); }
(rule__Member__Alternatives_2_7_3)*
{ after(grammarAccess.getMemberAccess().getAlternatives_2_7_3()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_4()); }
(rule__Member__Group_2_7_4__0)?
{ after(grammarAccess.getMemberAccess().getGroup_2_7_4()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getAlternatives_2_7_5()); }
(rule__Member__Alternatives_2_7_5)
{ after(grammarAccess.getMemberAccess().getAlternatives_2_7_5()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_6()); }
(rule__Member__Group_2_7_6__0)?
{ after(grammarAccess.getMemberAccess().getGroup_2_7_6()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getRightParenthesisKeyword_2_7_7()); }

	KEYWORD_6 

{ after(grammarAccess.getMemberAccess().getRightParenthesisKeyword_2_7_7()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_8()); }
(rule__Member__Group_2_7_8__0)?
{ after(grammarAccess.getMemberAccess().getGroup_2_7_8()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getAlternatives_2_7_9()); }
(rule__Member__Alternatives_2_7_9)?
{ after(grammarAccess.getMemberAccess().getAlternatives_2_7_9()); }
)
...
:
	rule__Member__Group_2_7_4__0__Impl
	rule__Member__Group_2_7_4__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getLessThanSignKeyword_2_7_4_0()); }

	KEYWORD_15 

{ after(grammarAccess.getMemberAccess().getLessThanSignKeyword_2_7_4_0()); }
)
...
:
	rule__Member__Group_2_7_4__1__Impl
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeParametersAssignment_2_7_4_1()); }
(rule__Member__TypeParametersAssignment_2_7_4_1)
{ after(grammarAccess.getMemberAccess().getTypeParametersAssignment_2_7_4_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_4_2()); }
(rule__Member__Group_2_7_4_2__0)*
{ after(grammarAccess.getMemberAccess().getGroup_2_7_4_2()); }
)
...
:
	rule__Member__Group_2_7_4__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getGreaterThanSignKeyword_2_7_4_3()); }

	KEYWORD_17 

{ after(grammarAccess.getMemberAccess().getGreaterThanSignKeyword_2_7_4_3()); }
)
...
:
	rule__Member__Group_2_7_4_2__0__Impl
...
:
(
{ before(grammarAccess.getMemberAccess().getCommaKeyword_2_7_4_2_0()); }

	KEYWORD_9 

{ after(grammarAccess.getMemberAccess().getCommaKeyword_2_7_4_2_0()); }
)
...
:
	rule__Member__Group_2_7_4_2__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeParametersAssignment_2_7_4_2_1()); }
(rule__Member__TypeParametersAssignment_2_7_4_2_1)
{ after(grammarAccess.getMemberAccess().getTypeParametersAssignment_2_7_4_2_1()); }
)
...
:
	rule__Member__Group_2_7_5_0__0__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_5_0_0()); }
(rule__Member__Group_2_7_5_0_0__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_7_5_0_0()); }
)
...
:
	rule__Member__Group_2_7_5_0_0__0__Impl
...
:
(
{ before(grammarAccess.getMemberAccess().getReturnTypeAssignment_2_7_5_0_0_0()); }
(rule__Member__ReturnTypeAssignment_2_7_5_0_0_0)
{ after(grammarAccess.getMemberAccess().getReturnTypeAssignment_2_7_5_0_0_0()); }
)
...
:
	...
	rule__Member__Group_2_7_5_0_0__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getCreateExtensionInfoAssignment_2_7_5_0_0_1()); }
(rule__Member__CreateExtensionInfoAssignment_2_7_5_0_0_1)
{ after(grammarAccess.getMemberAccess().getCreateExtensionInfoAssignment_2_7_5_0_0_1()); }
)
...
:
	rule__Member__Group_2_7_5_0_0__2__Impl
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_0_0_2()); }
(rule__Member__NameAssignment_2_7_5_0_0_2)
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_0_0_2()); }
)
...
:
	rule__Member__Group_2_7_5_0_0__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_0_0_3()); }

	KEYWORD_5 

{ after(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_0_0_3()); }
)
...
:
	rule__Member__Group_2_7_5_1__0__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_5_1_0()); }
(rule__Member__Group_2_7_5_1_0__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_7_5_1_0()); }
)
...
:
	rule__Member__Group_2_7_5_1_0__0__Impl
	rule__Member__Group_2_7_5_1_0__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getReturnTypeAssignment_2_7_5_1_0_0()); }
(rule__Member__ReturnTypeAssignment_2_7_5_1_0_0)
{ after(grammarAccess.getMemberAccess().getReturnTypeAssignment_2_7_5_1_0_0()); }
)
...
:
	rule__Member__Group_2_7_5_1_0__1__Impl
	rule__Member__Group_2_7_5_1_0__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_1_0_1()); }
(rule__Member__NameAssignment_2_7_5_1_0_1)
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_1_0_1()); }
)
...
:
	rule__Member__Group_2_7_5_1_0__2__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_1_0_2()); }

	KEYWORD_5 

{ after(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_1_0_2()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_5_2_0()); }
(rule__Member__Group_2_7_5_2_0__0)
{ after(grammarAccess.getMemberAccess().getGroup_2_7_5_2_0()); }
)
...
:
	rule__Member__Group_2_7_5_2_0__0__Impl
	rule__Member__Group_2_7_5_2_0__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getCreateExtensionInfoAssignment_2_7_5_2_0_0()); }
(rule__Member__CreateExtensionInfoAssignment_2_7_5_2_0_0)
{ after(grammarAccess.getMemberAccess().getCreateExtensionInfoAssignment_2_7_5_2_0_0()); }
)
...
:
	...
	rule__Member__Group_2_7_5_2_0__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_2_0_1()); }
(rule__Member__NameAssignment_2_7_5_2_0_1)
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_2_0_1()); }
)
...
:
	rule__Member__Group_2_7_5_2_0__2__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_2_0_2()); }

	KEYWORD_5 

{ after(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_2_0_2()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_3_0()); }
(rule__Member__NameAssignment_2_7_5_3_0)
{ after(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_3_0()); }
)
...
:
	rule__Member__Group_2_7_5_3__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_3_1()); }

	KEYWORD_5 

{ after(grammarAccess.getMemberAccess().getLeftParenthesisKeyword_2_7_5_3_1()); }
)
...
:
	rule__Member__Group_2_7_6__0__Impl
	rule__Member__Group_2_7_6__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getParametersAssignment_2_7_6_0()); }
(rule__Member__ParametersAssignment_2_7_6_0)
{ after(grammarAccess.getMemberAccess().getParametersAssignment_2_7_6_0()); }
)
...
:
	rule__Member__Group_2_7_6__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
	...
	rule__Member__Group_2_7_6_1__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getCommaKeyword_2_7_6_1_0()); }

	KEYWORD_9 

{ after(grammarAccess.getMemberAccess().getCommaKeyword_2_7_6_1_0()); }
)
...
:
	rule__Member__Group_2_7_6_1__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getParametersAssignment_2_7_6_1_1()); }
(rule__Member__ParametersAssignment_2_7_6_1_1)
{ after(grammarAccess.getMemberAccess().getParametersAssignment_2_7_6_1_1()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getThrowsKeyword_2_7_8_0()); }

	KEYWORD_91 

{ after(grammarAccess.getMemberAccess().getThrowsKeyword_2_7_8_0()); }
)
...
:
	rule__Member__Group_2_7_8__1__Impl
	rule__Member__Group_2_7_8__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getExceptionsAssignment_2_7_8_1()); }
(rule__Member__ExceptionsAssignment_2_7_8_1)
{ after(grammarAccess.getMemberAccess().getExceptionsAssignment_2_7_8_1()); }
)
...
:
	rule__Member__Group_2_7_8__2__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getGroup_2_7_8_2()); }
(rule__Member__Group_2_7_8_2__0)*
{ after(grammarAccess.getMemberAccess().getGroup_2_7_8_2()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getCommaKeyword_2_7_8_2_0()); }

	KEYWORD_9 

{ after(grammarAccess.getMemberAccess().getCommaKeyword_2_7_8_2_0()); }
)
...
:
	rule__Member__Group_2_7_8_2__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMemberAccess().getExceptionsAssignment_2_7_8_2_1()); }
(rule__Member__ExceptionsAssignment_2_7_8_2_1)
{ after(grammarAccess.getMemberAccess().getExceptionsAssignment_2_7_8_2_1()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getXListLiteralAction_1_0()); }
(

)
{ after(grammarAccess.getXAnnotationElementValueAccess().getXListLiteralAction_1_0()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getGroup_1_1()); }
(rule__XAnnotationElementValue__Group_1_1__0)
{ after(grammarAccess.getXAnnotationElementValueAccess().getGroup_1_1()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getGroup_1_2()); }
(rule__XAnnotationElementValue__Group_1_2__0)*
{ after(grammarAccess.getXAnnotationElementValueAccess().getGroup_1_2()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getRightSquareBracketKeyword_1_3()); }

	KEYWORD_21 

{ after(grammarAccess.getXAnnotationElementValueAccess().getRightSquareBracketKeyword_1_3()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getGroup_1_1_0()); }
(rule__XAnnotationElementValue__Group_1_1_0__0)
{ after(grammarAccess.getXAnnotationElementValueAccess().getGroup_1_1_0()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getNumberSignKeyword_1_1_0_0()); }

	KEYWORD_2 

{ after(grammarAccess.getXAnnotationElementValueAccess().getNumberSignKeyword_1_1_0_0()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getLeftSquareBracketKeyword_1_1_0_1()); }

	KEYWORD_20 

{ after(grammarAccess.getXAnnotationElementValueAccess().getLeftSquareBracketKeyword_1_1_0_1()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getElementsAssignment_1_1_0_2()); }
(rule__XAnnotationElementValue__ElementsAssignment_1_1_0_2)
{ after(grammarAccess.getXAnnotationElementValueAccess().getElementsAssignment_1_1_0_2()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getCommaKeyword_1_2_0()); }

	KEYWORD_9 

{ after(grammarAccess.getXAnnotationElementValueAccess().getCommaKeyword_1_2_0()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getElementsAssignment_1_2_1()); }
(rule__XAnnotationElementValue__ElementsAssignment_1_2_1)
{ after(grammarAccess.getXAnnotationElementValueAccess().getElementsAssignment_1_2_1()); }
)
...
:
(
{ before(grammarAccess.getSpecFileAccess().getImportSectionXImportSectionParserRuleCall_2_0()); }
	ruleXImportSection{ after(grammarAccess.getSpecFileAccess().getImportSectionXImportSectionParserRuleCall_2_0()); }
)
...
:
(
{ before(grammarAccess.getSpecFileAccess().getXtendTypesExampleGroupParserRuleCall_3_0()); }
	ruleExampleGroup{ after(grammarAccess.getSpecFileAccess().getXtendTypesExampleGroupParserRuleCall_3_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getPendingPendingKeyword_2_0_1_0_0()); }
(
{ before(grammarAccess.getMemberAccess().getPendingPendingKeyword_2_0_1_0_0()); }

	KEYWORD_98 

{ after(grammarAccess.getMemberAccess().getPendingPendingKeyword_2_0_1_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExprXExpressionParserRuleCall_2_0_1_2_0()); }
	ruleXExpression{ after(grammarAccess.getMemberAccess().getExprXExpressionParserRuleCall_2_0_1_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionXBlockExpressionParserRuleCall_2_0_1_3_0()); }
	ruleXBlockExpression{ after(grammarAccess.getMemberAccess().getExpressionXBlockExpressionParserRuleCall_2_0_1_3_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAllKeyword_2_2_1_1_0_0()); }
(
{ before(grammarAccess.getMemberAccess().getModifiersAllKeyword_2_2_1_1_0_0()); }

	KEYWORD_51 

{ after(grammarAccess.getMemberAccess().getModifiersAllKeyword_2_2_1_1_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameSTRINGTerminalRuleCall_2_2_1_2_0()); }
	RULE_STRING{ after(grammarAccess.getMemberAccess().getNameSTRINGTerminalRuleCall_2_2_1_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionXExpressionParserRuleCall_2_2_1_3_0()); }
	ruleXExpression{ after(grammarAccess.getMemberAccess().getExpressionXExpressionParserRuleCall_2_2_1_3_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersAllKeyword_2_3_1_1_0_0()); }
(
{ before(grammarAccess.getMemberAccess().getModifiersAllKeyword_2_3_1_1_0_0()); }

	KEYWORD_51 

{ after(grammarAccess.getMemberAccess().getModifiersAllKeyword_2_3_1_1_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameSTRINGTerminalRuleCall_2_3_1_2_0()); }
	RULE_STRING{ after(grammarAccess.getMemberAccess().getNameSTRINGTerminalRuleCall_2_3_1_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionXExpressionParserRuleCall_2_3_1_3_0()); }
	ruleXExpression{ after(grammarAccess.getMemberAccess().getExpressionXExpressionParserRuleCall_2_3_1_3_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersFieldModifierParserRuleCall_2_6_2_0_0_0()); }
	ruleFieldModifier{ after(grammarAccess.getMemberAccess().getModifiersFieldModifierParserRuleCall_2_6_2_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_0_1_0()); }
	ruleCommonModifier{ after(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_0_2_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_0_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_0_3_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_0_3_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersExtensionKeyword_2_6_2_1_0_0()); }
(
{ before(grammarAccess.getMemberAccess().getModifiersExtensionKeyword_2_6_2_1_0_0()); }

	KEYWORD_107 

{ after(grammarAccess.getMemberAccess().getModifiersExtensionKeyword_2_6_2_1_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersFieldModifierParserRuleCall_2_6_2_1_1_0_0()); }
	ruleFieldModifier{ after(grammarAccess.getMemberAccess().getModifiersFieldModifierParserRuleCall_2_6_2_1_1_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_1_1_1_0()); }
	ruleCommonModifier{ after(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_1_1_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_1_2_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_1_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_1_3_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_1_3_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersFieldModifierParserRuleCall_2_6_2_2_0_0()); }
	ruleFieldModifier{ after(grammarAccess.getMemberAccess().getModifiersFieldModifierParserRuleCall_2_6_2_2_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_2_1_0()); }
	ruleCommonModifier{ after(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_2_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersExtensionKeyword_2_6_2_2_2_0()); }
(
{ before(grammarAccess.getMemberAccess().getModifiersExtensionKeyword_2_6_2_2_2_0()); }

	KEYWORD_107 

{ after(grammarAccess.getMemberAccess().getModifiersExtensionKeyword_2_6_2_2_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_2_3_0()); }
	ruleCommonModifier{ after(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_6_2_2_3_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_2_4_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_2_4_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_2_5_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_2_5_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_3_0_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_6_2_3_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_3_1_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_6_2_3_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_7_1_0()); }
	ruleCommonModifier{ after(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_7_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersMethodModifierParserRuleCall_2_7_2_0()); }
	ruleMethodModifier{ after(grammarAccess.getMemberAccess().getModifiersMethodModifierParserRuleCall_2_7_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_7_3_0_0()); }
	ruleCommonModifier{ after(grammarAccess.getMemberAccess().getModifiersCommonModifierParserRuleCall_2_7_3_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getModifiersMethodModifierParserRuleCall_2_7_3_1_0()); }
	ruleMethodModifier{ after(grammarAccess.getMemberAccess().getModifiersMethodModifierParserRuleCall_2_7_3_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeParametersJvmTypeParameterParserRuleCall_2_7_4_1_0()); }
	ruleJvmTypeParameter{ after(grammarAccess.getMemberAccess().getTypeParametersJvmTypeParameterParserRuleCall_2_7_4_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getTypeParametersJvmTypeParameterParserRuleCall_2_7_4_2_1_0()); }
	ruleJvmTypeParameter{ after(grammarAccess.getMemberAccess().getTypeParametersJvmTypeParameterParserRuleCall_2_7_4_2_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getReturnTypeJvmTypeReferenceParserRuleCall_2_7_5_0_0_0_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getReturnTypeJvmTypeReferenceParserRuleCall_2_7_5_0_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getCreateExtensionInfoCreateExtensionInfoParserRuleCall_2_7_5_0_0_1_0()); }
	ruleCreateExtensionInfo{ after(grammarAccess.getMemberAccess().getCreateExtensionInfoCreateExtensionInfoParserRuleCall_2_7_5_0_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_0_0_2_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_0_0_2_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getReturnTypeJvmTypeReferenceParserRuleCall_2_7_5_1_0_0_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getReturnTypeJvmTypeReferenceParserRuleCall_2_7_5_1_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_1_0_1_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_1_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getCreateExtensionInfoCreateExtensionInfoParserRuleCall_2_7_5_2_0_0_0()); }
	ruleCreateExtensionInfo{ after(grammarAccess.getMemberAccess().getCreateExtensionInfoCreateExtensionInfoParserRuleCall_2_7_5_2_0_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_2_0_1_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_2_0_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_3_0_0()); }
	ruleValidID{ after(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_7_5_3_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getParametersParameterParserRuleCall_2_7_6_0_0()); }
	ruleParameter{ after(grammarAccess.getMemberAccess().getParametersParameterParserRuleCall_2_7_6_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getParametersParameterParserRuleCall_2_7_6_1_1_0()); }
	ruleParameter{ after(grammarAccess.getMemberAccess().getParametersParameterParserRuleCall_2_7_6_1_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExceptionsJvmTypeReferenceParserRuleCall_2_7_8_1_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getExceptionsJvmTypeReferenceParserRuleCall_2_7_8_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExceptionsJvmTypeReferenceParserRuleCall_2_7_8_2_1_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMemberAccess().getExceptionsJvmTypeReferenceParserRuleCall_2_7_8_2_1_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionXBlockExpressionParserRuleCall_2_7_9_0_0()); }
	ruleXBlockExpression{ after(grammarAccess.getMemberAccess().getExpressionXBlockExpressionParserRuleCall_2_7_9_0_0()); }
)
...
:
(
{ before(grammarAccess.getMemberAccess().getExpressionRichStringParserRuleCall_2_7_9_1_0()); }
	ruleRichString{ after(grammarAccess.getMemberAccess().getExpressionRichStringParserRuleCall_2_7_9_1_0()); }
)
...
{ before(grammarAccess.getXRelationalExpressionAccess().getFeatureJvmIdentifiableElementShouldParserRuleCall_1_0_0_0_1_0_1()); }
	ruleShould{ after(grammarAccess.getXRelationalExpressionAccess().getFeatureJvmIdentifiableElementShouldParserRuleCall_1_0_0_0_1_0_1()); }
)
...
{ before(grammarAccess.getXRelationalExpressionAccess().getTypeJvmTypeReferenceParserRuleCall_1_2_1_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getXRelationalExpressionAccess().getTypeJvmTypeReferenceParserRuleCall_1_2_1_0()); }
)
...
{ before(grammarAccess.getXRelationalExpressionAccess().getFeatureJvmIdentifiableElementOpCompareParserRuleCall_1_3_0_0_1_0_1()); }
	ruleOpCompare{ after(grammarAccess.getXRelationalExpressionAccess().getFeatureJvmIdentifiableElementOpCompareParserRuleCall_1_3_0_0_1_0_1()); }
)
...
{ before(grammarAccess.getXRelationalExpressionAccess().getRightOperandXOtherOperatorExpressionParserRuleCall_1_3_1_0()); }
	ruleXOtherOperatorExpression{ after(grammarAccess.getXRelationalExpressionAccess().getRightOperandXOtherOperatorExpressionParserRuleCall_1_3_1_0()); }
)
...
:
(
{ before(grammarAccess.getExampleRowAccess().getCellsExampleCellParserRuleCall_2_0_0()); }
	ruleExampleCell{ after(grammarAccess.getExampleRowAccess().getCellsExampleCellParserRuleCall_2_0_0()); }
)
...
:
(
{ before(grammarAccess.getExampleCellAccess().getExpressionXExpressionParserRuleCall_0()); }
	ruleXExpression{ after(grammarAccess.getExampleCellAccess().getExpressionXExpressionParserRuleCall_0()); }
)
...
:
(
{ before(grammarAccess.getAnnotationFieldAccess().getInitialValueXAnnotationElementValueParserRuleCall_3_1_0()); }
	ruleXAnnotationElementValue{ after(grammarAccess.getAnnotationFieldAccess().getInitialValueXAnnotationElementValueParserRuleCall_3_1_0()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getElementsXAnnotationParserRuleCall_1_1_0_2_0()); }
	ruleXAnnotation{ after(grammarAccess.getXAnnotationElementValueAccess().getElementsXAnnotationParserRuleCall_1_1_0_2_0()); }
)
...
:
(
{ before(grammarAccess.getXAnnotationElementValueAccess().getElementsXAnnotationParserRuleCall_1_2_1_0()); }
	ruleXAnnotation{ after(grammarAccess.getXAnnotationElementValueAccess().getElementsXAnnotationParserRuleCall_1_2_1_0()); }
)
