		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeAccess().getPreambleAssignment_2_4_1(), "rule__Type__PreambleAssignment_2_4_1");
					put(grammarAccess.getTypeAccess().getTargetTypeAssignment_2_4_2(), "rule__Type__TargetTypeAssignment_2_4_2");
