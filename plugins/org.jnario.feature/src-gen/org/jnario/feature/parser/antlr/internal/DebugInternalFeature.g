...
* generated by Xtext
*/
grammar DebugInternalFeature ;

// Rule FeatureFile
ruleFeatureFile :
	(
		'package' ruleQualifiedName
	)? ruleXImportSection? ruleFeature?
;

// Rule Feature
ruleFeature :
	ruleXAnnotation* RULE_FEATURE_TEXT RULE_TEXT? ruleBackground? ruleScenario*
;

// Rule Background
ruleBackground :
	RULE_BACKGROUND_TEXT ruleMember* (
		(
			ruleGiven |
			ruleGivenReference
		) (
...
// Rule Given
ruleGiven :
	RULE_GIVEN_TEXT ruleBlockExpression
;
...
// Rule When
ruleWhen :
	RULE_WHEN_TEXT ruleBlockExpression
;
...
// Rule Then
ruleThen :
	RULE_THEN_TEXT ruleBlockExpression
;
...
// Rule And
ruleAnd :
	RULE_AND_TEXT ruleBlockExpression
;
...
// Rule But
ruleBut :
	RULE_BUT_TEXT ruleBlockExpression
;
...
ruleXRelationalExpression :
	ruleXOtherOperatorExpression (
		( (
		ruleShould
		) => ruleShould ) ruleXOtherOperatorExpression |
		( (
		'should' 'throw' |
		'throws'
		) => (
...
RULE_GIVEN_TEXT :
	'Given ' RULE_STEP_WITH_ARGS
;

RULE_WHEN_TEXT :
	'When ' RULE_STEP_WITH_ARGS
;

RULE_THEN_TEXT :
	'Then ' RULE_STEP_WITH_ARGS
;

RULE_AND_TEXT :
	'And ' RULE_STEP_WITH_ARGS
;

RULE_BUT_TEXT :
	'But ' RULE_STEP_WITH_ARGS
;
