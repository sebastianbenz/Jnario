...
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureFileAccess().getXtendClassesFeatureParserRuleCall_3_0()); 
	    }
		lv_xtendClasses_4_0=ruleFeature		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFeatureFileRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getMemberAccess().getVisibilityVisibilityEnumRuleCall_2_1_0()); 
	    }
...
(
    ...
    {
        newLeafNode(lv_extension_4_0, grammarAccess.getMemberAccess().getExtensionExtensionKeyword_2_2_0_0_0());
    }
...
(
    ...
    {
        newLeafNode(lv_static_5_0, grammarAccess.getMemberAccess().getStaticStaticKeyword_2_2_0_1_0());
    }
...
(
		lv_final_6_0=	'val' 
    {
        newLeafNode(lv_final_6_0, grammarAccess.getMemberAccess().getFinalValKeyword_2_2_0_2_0_0());
    }
    ...
    |	otherlv_7='var' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getMemberAccess().getVarKeyword_2_2_0_2_1());
    }
)?(
(
		{ 
	        newCompositeNode(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_2_0_3_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_2_0_4_0()); 
	    }
...
(
    ...
    {
        newLeafNode(lv_static_10_0, grammarAccess.getMemberAccess().getStaticStaticKeyword_2_2_1_0_0());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_2_1_1_0_0()); 
	    }
...
(
		lv_final_12_0=	'val' 
    {
        newLeafNode(lv_final_12_0, grammarAccess.getMemberAccess().getFinalValKeyword_2_2_1_1_1_0_0_0());
    }
    ...
    |	otherlv_13='var' 
    {
    	newLeafNode(otherlv_13, grammarAccess.getMemberAccess().getVarKeyword_2_2_1_1_1_0_1());
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getMemberAccess().getTypeJvmTypeReferenceParserRuleCall_2_2_1_1_1_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getMemberAccess().getNameValidIDParserRuleCall_2_2_1_2_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_16, grammarAccess.getMemberAccess().getEqualsSignKeyword_2_3_0());
    }
(
(
		{ 
		...
		lv_initialValue_17_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMemberRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_18, grammarAccess.getMemberAccess().getSemicolonKeyword_2_4());
    }
)?))
;
...
(((((
    ...
    |
    { 
        newCompositeNode(grammarAccess.getXLiteralAccess().getMockLiteralParserRuleCall_6()); 
    }
    this_MockLiteral_6=ruleMockLiteral
    { 
        $current = $this_MockLiteral_6.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleMockLiteral returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMockLiteralRule()); }
	 iv_ruleMockLiteral=ruleMockLiteral 
	 { $current=$iv_ruleMockLiteral.current; } 
	 EOF 
;

// Rule MockLiteral
ruleMockLiteral returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getMockLiteralAccess().getMockLiteralAction_0(),
            $current);
    }
)(	otherlv_1='mock' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getMockLiteralAccess().getMockKeyword_1_0());
    }

    |	otherlv_2='stub' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getMockLiteralAccess().getStubKeyword_1_1());
    }
)	otherlv_3='(' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getMockLiteralAccess().getLeftParenthesisKeyword_2());
    }
(
(
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getMockLiteralRule());
	        }
        }
		{ 
	        newCompositeNode(grammarAccess.getMockLiteralAccess().getTypeJvmTypeCrossReference_3_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getMockLiteralAccess().getRightParenthesisKeyword_4());
    }
)
;
