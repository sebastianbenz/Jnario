package de.bmw.carit.jnario.feature.jvmmodel;
...
import de.bmw.carit.jnario.feature.feature.Background;
import de.bmw.carit.jnario.feature.feature.Feature;
import de.bmw.carit.jnario.feature.feature.FeatureFile;
import de.bmw.carit.jnario.feature.feature.Scenario;
import de.bmw.carit.jnario.feature.feature.Step;
import de.bmw.carit.jnario.feature.feature.StepExpression;
...
public class FeatureJvmModelInferrer extends CommonJvmModelInferrer {
        ...
        public void apply(final JvmGenericType it) {
          {
            ...
            JvmAnnotationReference _annotation = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(feature, org.junit.runner.RunWith.class, de.bmw.carit.jnario.runner.FeatureRunner.class);
            CollectionExtensions.<JvmAnnotationReference>operator_add(_annotations, _annotation);
            EList<JvmAnnotationReference> _annotations_1 = it.getAnnotations();
            JvmAnnotationReference _annotation_1 = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(feature, de.bmw.carit.jnario.runner.Contains.class, scenarios);
  ...
  public JvmAnnotationReference runnerAnnotations(final Scenario scenario) {
    ...
    if (_isEmpty) {
      JvmAnnotationReference _annotation = this._extendedJvmTypesBuilder.toAnnotation(scenario, org.junit.runner.RunWith.class, de.bmw.carit.jnario.runner.FeatureRunner.class);
      _xifexpression = _annotation;
    } else {
      JvmAnnotationReference _annotation_1 = this._extendedJvmTypesBuilder.toAnnotation(scenario, org.junit.runner.RunWith.class, de.bmw.carit.jnario.runner.FeatureExamplesRunner.class);
        ...
        public void apply(final JvmGenericType it) {
          {
            ...
            JvmAnnotationReference _annotation = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(scenario, de.bmw.carit.jnario.runner.Named.class, _trim);
            CollectionExtensions.<JvmAnnotationReference>operator_add(_annotations, _annotation);
            String _package = featureFile.getPackage();
            it.setPackageName(_package);
            ...
            if (_operator_not) {
              {
                ...
                if (_operator_not_1) {
                  EList<JvmAnnotationReference> _annotations_1 = it.getAnnotations();
                  JvmAnnotationReference _annotation_1 = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(scenario, de.bmw.carit.jnario.runner.Contains.class, exampleClasses);
                  CollectionExtensions.<JvmAnnotationReference>operator_add(_annotations_1, _annotation_1);
                }
              }
            }
          ...
          for (final ExampleTable table : _examples_1) {
            {
              ...
              UnmodifiableIterator<ExampleColumn> _filter = Iterators.<ExampleColumn>filter(_eAllContents, de.bmw.carit.jnario.common.ExampleColumn.class);
          ...
          public void apply(final JvmOperation it) {
            {
              ...
              JvmAnnotationReference _annotation_1 = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(step, de.bmw.carit.jnario.runner.Order.class, Integer.valueOf(_intValue));
              CollectionExtensions.<JvmAnnotationReference>operator_add(_annotations_1, _annotation_1);
              ...
              JvmAnnotationReference _annotation_2 = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(step, de.bmw.carit.jnario.runner.Named.class, _nameOf);
          ...
          public void apply(final JvmGenericType it) {
            {
              ...
              EList<JvmAnnotationReference> _annotations = it.getAnnotations();
              JvmAnnotationReference _annotation = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(row, org.junit.runner.RunWith.class, de.bmw.carit.jnario.runner.FeatureRunner.class);
              CollectionExtensions.<JvmAnnotationReference>operator_add(_annotations, _annotation);
              ...
              JvmAnnotationReference _annotation_1 = FeatureJvmModelInferrer.this._extendedJvmTypesBuilder.toAnnotation(row, de.bmw.carit.jnario.runner.Named.class, _replace);
              CollectionExtensions.<JvmAnnotationReference>operator_add(_annotations_1, _annotation_1);
            }
          }
        };
