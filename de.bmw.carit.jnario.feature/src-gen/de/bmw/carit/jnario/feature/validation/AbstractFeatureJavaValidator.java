package de.bmw.carit.jnario.feature.validation;
...
public class AbstractFeatureJavaValidator extends Xtend2JavaValidator {
	...
	protected List<EPackage> getEPackages() {
	    ...
	    result.add(de.bmw.carit.jnario.feature.feature.FeaturePackage.eINSTANCE);
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.eclipse.org/xtext/Xtend2"));
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.eclipse.org/xtext/xbase/Xbase"));
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.bmw.de/carit/jnario/Common"));
