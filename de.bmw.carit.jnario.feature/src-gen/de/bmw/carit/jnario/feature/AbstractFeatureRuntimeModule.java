...
/**
 * Manual modifications go to {de.bmw.carit.jnario.feature.FeatureRuntimeModule}
 */
...
public abstract class AbstractFeatureRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/bmw/carit/jnario/feature/Feature.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.bmw.carit.jnario.feature.Feature");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return de.bmw.carit.jnario.feature.services.FeatureGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return de.bmw.carit.jnario.feature.serializer.AbstractFeatureSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return de.bmw.carit.jnario.feature.serializer.AbstractFeatureSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return de.bmw.carit.jnario.feature.parser.antlr.FeatureParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return de.bmw.carit.jnario.feature.parser.antlr.FeatureAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return de.bmw.carit.jnario.feature.parser.antlr.internal.InternalFeatureLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<de.bmw.carit.jnario.feature.parser.antlr.internal.InternalFeatureLexer> provideInternalFeatureLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(de.bmw.carit.jnario.feature.parser.antlr.internal.InternalFeatureLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(de.bmw.carit.jnario.feature.parser.antlr.internal.InternalFeatureLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends de.bmw.carit.jnario.feature.validation.FeatureJavaValidator> bindFeatureJavaValidator() {
		return de.bmw.carit.jnario.feature.validation.FeatureJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return de.bmw.carit.jnario.feature.formatting.FeatureFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return de.bmw.carit.jnario.feature.jvmmodel.FeatureJvmModelInferrer.class;
	}
