		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getScenarioAccess().getStepsAssignment_1(), "rule__Scenario__StepsAssignment_1");
					put(grammarAccess.getScenarioAccess().getExamplesAssignment_2(), "rule__Scenario__ExamplesAssignment_2");
					...
					put(grammarAccess.getExampleHeadingCellAccess().getNameAssignment_2(), "rule__ExampleHeadingCell__NameAssignment_2");
