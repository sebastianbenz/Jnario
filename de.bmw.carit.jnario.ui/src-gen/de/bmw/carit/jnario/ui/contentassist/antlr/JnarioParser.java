		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGivenRefAccess().getGroup(), "rule__GivenRef__Group__0");
					put(grammarAccess.getGivenAccess().getGroup(), "rule__Given__Group__0");
					put(grammarAccess.getWhenRefAccess().getGroup(), "rule__WhenRef__Group__0");
					put(grammarAccess.getWhenAccess().getGroup(), "rule__When__Group__0");
					put(grammarAccess.getThenRefAccess().getGroup(), "rule__ThenRef__Group__0");
					put(grammarAccess.getThenAccess().getGroup(), "rule__Then__Group__0");
					put(grammarAccess.getAndRefAccess().getGroup(), "rule__AndRef__Group__0");
					...
					put(grammarAccess.getGivenRefAccess().getReferenceAssignment_1(), "rule__GivenRef__ReferenceAssignment_1");
					put(grammarAccess.getGivenRefAccess().getAndAssignment_2(), "rule__GivenRef__AndAssignment_2");
					put(grammarAccess.getGivenAccess().getNameAssignment_1(), "rule__Given__NameAssignment_1");
					put(grammarAccess.getGivenAccess().getCodeAssignment_2(), "rule__Given__CodeAssignment_2");
					put(grammarAccess.getGivenAccess().getAndAssignment_3(), "rule__Given__AndAssignment_3");
					put(grammarAccess.getWhenRefAccess().getReferenceAssignment_1(), "rule__WhenRef__ReferenceAssignment_1");
					put(grammarAccess.getWhenRefAccess().getAndAssignment_2(), "rule__WhenRef__AndAssignment_2");
					put(grammarAccess.getWhenAccess().getNameAssignment_1(), "rule__When__NameAssignment_1");
					put(grammarAccess.getWhenAccess().getCodeAssignment_2(), "rule__When__CodeAssignment_2");
					put(grammarAccess.getWhenAccess().getAndAssignment_3(), "rule__When__AndAssignment_3");
					put(grammarAccess.getThenRefAccess().getReferenceAssignment_1(), "rule__ThenRef__ReferenceAssignment_1");
					put(grammarAccess.getThenRefAccess().getAndAssignment_2(), "rule__ThenRef__AndAssignment_2");
					put(grammarAccess.getThenAccess().getNameAssignment_1(), "rule__Then__NameAssignment_1");
					put(grammarAccess.getThenAccess().getCodeAssignment_2(), "rule__Then__CodeAssignment_2");
					put(grammarAccess.getThenAccess().getAndAssignment_3(), "rule__Then__AndAssignment_3");
					put(grammarAccess.getAndRefAccess().getReferenceAssignment_1(), "rule__AndRef__ReferenceAssignment_1");
					put(grammarAccess.getAndAccess().getNameAssignment_1(), "rule__And__NameAssignment_1");
					put(grammarAccess.getAndAccess().getCodeAssignment_2(), "rule__And__CodeAssignment_2");
