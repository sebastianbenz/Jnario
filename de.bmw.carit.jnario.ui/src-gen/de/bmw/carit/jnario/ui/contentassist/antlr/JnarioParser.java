		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJnarioAccess().getNameAssignment_0(), "rule__Jnario__NameAssignment_0");
					put(grammarAccess.getJnarioAccess().getScenariosAssignment_1(), "rule__Jnario__ScenariosAssignment_1");
					put(grammarAccess.getScenarioAccess().getNameAssignment_0(), "rule__Scenario__NameAssignment_0");
					put(grammarAccess.getScenarioAccess().getGivenAssignment_1(), "rule__Scenario__GivenAssignment_1");
					put(grammarAccess.getScenarioAccess().getWhenAssignment_2(), "rule__Scenario__WhenAssignment_2");
					put(grammarAccess.getScenarioAccess().getThenAssignment_3(), "rule__Scenario__ThenAssignment_3");
					...
					put(grammarAccess.getGivenAccess().getNameAssignment_2_0(), "rule__Given__NameAssignment_2_0");
					put(grammarAccess.getGivenAccess().getCodeAssignment_2_1(), "rule__Given__CodeAssignment_2_1");
					...
					put(grammarAccess.getWhenAccess().getNameAssignment_2_0(), "rule__When__NameAssignment_2_0");
					put(grammarAccess.getWhenAccess().getCodeAssignment_2_1(), "rule__When__CodeAssignment_2_1");
					...
					put(grammarAccess.getThenAccess().getNameAssignment_2_0(), "rule__Then__NameAssignment_2_0");
					put(grammarAccess.getThenAccess().getCodeAssignment_2_1(), "rule__Then__CodeAssignment_2_1");
					put(grammarAccess.getCodeAccess().getExpressionsAssignment(), "rule__Code__ExpressionsAssignment");
