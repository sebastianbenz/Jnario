		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getScenarioAccess().getExamplesAssignment_3(), "rule__Scenario__ExamplesAssignment_3");
					...
					put(grammarAccess.getCodeAccess().getAnnotationsAssignment_1(), "rule__Code__AnnotationsAssignment_1");
					put(grammarAccess.getCodeAccess().getBlockExpressionAssignment_2(), "rule__Code__BlockExpressionAssignment_2");
