		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJnarioAccess().getFeatureNameAssignment_0(), "rule__Jnario__FeatureNameAssignment_0");
					put(grammarAccess.getJnarioAccess().getScenariosAssignment_1(), "rule__Jnario__ScenariosAssignment_1");
					put(grammarAccess.getScenarioAccess().getScenarioNameAssignment_0(), "rule__Scenario__ScenarioNameAssignment_0");
					put(grammarAccess.getScenarioAccess().getSpecAssignment_1(), "rule__Scenario__SpecAssignment_1");
					put(grammarAccess.getSentenceAccess().getGivenAssignment_0(), "rule__Sentence__GivenAssignment_0");
					put(grammarAccess.getSentenceAccess().getWhenAssignment_1(), "rule__Sentence__WhenAssignment_1");
					put(grammarAccess.getSentenceAccess().getThenAssignment_2(), "rule__Sentence__ThenAssignment_2");
					put(grammarAccess.getGivenAccess().getDescAssignment_0(), "rule__Given__DescAssignment_0");
					put(grammarAccess.getGivenAccess().getCodeAssignment_1(), "rule__Given__CodeAssignment_1");
					put(grammarAccess.getWhenAccess().getDescAssignment_0(), "rule__When__DescAssignment_0");
					put(grammarAccess.getWhenAccess().getCodeAssignment_1(), "rule__When__CodeAssignment_1");
					put(grammarAccess.getThenAccess().getDescAssignment_0(), "rule__Then__DescAssignment_0");
