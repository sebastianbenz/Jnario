...
* generated by Xtext
*/
package de.bmw.carit.jnario.ui.contentassist.antlr;
...
public class JnarioParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.bmw.carit.jnario.ui.contentassist.antlr.internal.InternalJnarioParser createParser() {
		de.bmw.carit.jnario.ui.contentassist.antlr.internal.InternalJnarioParser result = new de.bmw.carit.jnario.ui.contentassist.antlr.internal.InternalJnarioParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getAlternatives_1_2_3_1(), "rule__XMemberFeatureCall__Alternatives_1_2_3_1");
					put(grammarAccess.getXFeatureCallAccess().getAlternatives_1(), "rule__XFeatureCall__Alternatives_1");
					put(grammarAccess.getXFeatureCallAccess().getAlternatives_1_1_3_1(), "rule__XFeatureCall__Alternatives_1_1_3_1");
					...
					put(grammarAccess.getWhenAccess().getGroup_2(), "rule__When__Group_2__0");
					put(grammarAccess.getThenAccess().getGroup(), "rule__Then__Group__0");
					put(grammarAccess.getThenAccess().getGroup_2(), "rule__Then__Group_2__0");
					...
					put(grammarAccess.getExampleCellAccess().getGroup(), "rule__ExampleCell__Group__0");
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_2_3_1_1_1(), "rule__XMemberFeatureCall__Group_1_2_3_1_1_1__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup(), "rule__XFeatureCall__Group__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup_1_0(), "rule__XFeatureCall__Group_1_0__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup_1_1(), "rule__XFeatureCall__Group_1_1__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup_1_1_1(), "rule__XFeatureCall__Group_1_1_1__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup_1_1_1_2(), "rule__XFeatureCall__Group_1_1_1_2__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup_1_1_3(), "rule__XFeatureCall__Group_1_1_3__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup_1_1_3_1_1(), "rule__XFeatureCall__Group_1_1_3_1_1__0");
					put(grammarAccess.getXFeatureCallAccess().getGroup_1_1_3_1_1_1(), "rule__XFeatureCall__Group_1_1_3_1_1_1__0");
					...
					put(grammarAccess.getScenarioAccess().getExamplesAssignment_5(), "rule__Scenario__ExamplesAssignment_5");
					put(grammarAccess.getAnnotationAccess().getAnnotationAssignment_0(), "rule__Annotation__AnnotationAssignment_0");
					put(grammarAccess.getAnnotationAccess().getVarAssignment_1(), "rule__Annotation__VarAssignment_1");
					put(grammarAccess.getVariableDeclarationAccess().getVisibilityAssignment_0(), "rule__VariableDeclaration__VisibilityAssignment_0");
					put(grammarAccess.getVariableDeclarationAccess().getVariableDecAssignment_1(), "rule__VariableDeclaration__VariableDecAssignment_1");
					put(grammarAccess.getGivenAccess().getNameAssignment_0(), "rule__Given__NameAssignment_0");
					put(grammarAccess.getGivenAccess().getCodeAssignment_1(), "rule__Given__CodeAssignment_1");
					put(grammarAccess.getGivenAccess().getAndAssignment_2_0(), "rule__Given__AndAssignment_2_0");
					put(grammarAccess.getGivenAccess().getAnd_codeAssignment_2_1(), "rule__Given__And_codeAssignment_2_1");
					put(grammarAccess.getWhenAccess().getNameAssignment_0(), "rule__When__NameAssignment_0");
					put(grammarAccess.getWhenAccess().getCodeAssignment_1(), "rule__When__CodeAssignment_1");
					put(grammarAccess.getWhenAccess().getAndAssignment_2_0(), "rule__When__AndAssignment_2_0");
					put(grammarAccess.getWhenAccess().getAnd_codeAssignment_2_1(), "rule__When__And_codeAssignment_2_1");
					put(grammarAccess.getThenAccess().getNameAssignment_0(), "rule__Then__NameAssignment_0");
					put(grammarAccess.getThenAccess().getCodeAssignment_1(), "rule__Then__CodeAssignment_1");
					put(grammarAccess.getThenAccess().getAndAssignment_2_0(), "rule__Then__AndAssignment_2_0");
					put(grammarAccess.getThenAccess().getAnd_codeAssignment_2_1(), "rule__Then__And_codeAssignment_2_1");
					put(grammarAccess.getAndAccess().getNameAssignment_0(), "rule__And__NameAssignment_0");
					put(grammarAccess.getAndAccess().getCodeAssignment_1(), "rule__And__CodeAssignment_1");
					put(grammarAccess.getCodeAccess().getAnnotationsAssignment_0(), "rule__Code__AnnotationsAssignment_0");
					put(grammarAccess.getCodeAccess().getBlockExpressionAssignment_1(), "rule__Code__BlockExpressionAssignment_1");
					put(grammarAccess.getBlockExpressionAccess().getExpressionsAssignment(), "rule__BlockExpression__ExpressionsAssignment");
					put(grammarAccess.getExamplesAccess().getNameAssignment_0(), "rule__Examples__NameAssignment_0");
					put(grammarAccess.getExamplesAccess().getHeadingAssignment_1(), "rule__Examples__HeadingAssignment_1");
					put(grammarAccess.getExamplesAccess().getRowsAssignment_2(), "rule__Examples__RowsAssignment_2");
					...
					put(grammarAccess.getExampleRowAccess().getPartsAssignment_0(), "rule__ExampleRow__PartsAssignment_0");
					put(grammarAccess.getExampleCellAccess().getNameAssignment_1(), "rule__ExampleCell__NameAssignment_1");
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getFeatureAssignment_1_1_0_0_1(), "rule__XMemberFeatureCall__FeatureAssignment_1_1_0_0_1");
					put(grammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsAssignment_1_1_1(), "rule__XMemberFeatureCall__MemberCallArgumentsAssignment_1_1_1");
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getSpreadingAssignment_1_2_0_0_1_2(), "rule__XMemberFeatureCall__SpreadingAssignment_1_2_0_0_1_2");
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsAssignment_1_2_3_1_1_0(), "rule__XMemberFeatureCall__MemberCallArgumentsAssignment_1_2_3_1_1_0");
					put(grammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsAssignment_1_2_3_1_1_1_1(), "rule__XMemberFeatureCall__MemberCallArgumentsAssignment_1_2_3_1_1_1_1");
					put(grammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsAssignment_1_2_4(), "rule__XMemberFeatureCall__MemberCallArgumentsAssignment_1_2_4");
					put(grammarAccess.getXFeatureCallAccess().getFeatureAssignment_1_0_0(), "rule__XFeatureCall__FeatureAssignment_1_0_0");
					put(grammarAccess.getXFeatureCallAccess().getFeatureCallArgumentsAssignment_1_0_1(), "rule__XFeatureCall__FeatureCallArgumentsAssignment_1_0_1");
					put(grammarAccess.getXFeatureCallAccess().getDeclaringTypeAssignment_1_1_0(), "rule__XFeatureCall__DeclaringTypeAssignment_1_1_0");
					put(grammarAccess.getXFeatureCallAccess().getTypeArgumentsAssignment_1_1_1_1(), "rule__XFeatureCall__TypeArgumentsAssignment_1_1_1_1");
					put(grammarAccess.getXFeatureCallAccess().getTypeArgumentsAssignment_1_1_1_2_1(), "rule__XFeatureCall__TypeArgumentsAssignment_1_1_1_2_1");
					put(grammarAccess.getXFeatureCallAccess().getFeatureAssignment_1_1_2(), "rule__XFeatureCall__FeatureAssignment_1_1_2");
					put(grammarAccess.getXFeatureCallAccess().getExplicitOperationCallAssignment_1_1_3_0(), "rule__XFeatureCall__ExplicitOperationCallAssignment_1_1_3_0");
					put(grammarAccess.getXFeatureCallAccess().getFeatureCallArgumentsAssignment_1_1_3_1_0(), "rule__XFeatureCall__FeatureCallArgumentsAssignment_1_1_3_1_0");
					put(grammarAccess.getXFeatureCallAccess().getFeatureCallArgumentsAssignment_1_1_3_1_1_0(), "rule__XFeatureCall__FeatureCallArgumentsAssignment_1_1_3_1_1_0");
					put(grammarAccess.getXFeatureCallAccess().getFeatureCallArgumentsAssignment_1_1_3_1_1_1_1(), "rule__XFeatureCall__FeatureCallArgumentsAssignment_1_1_3_1_1_1_1");
					put(grammarAccess.getXFeatureCallAccess().getFeatureCallArgumentsAssignment_1_1_4(), "rule__XFeatureCall__FeatureCallArgumentsAssignment_1_1_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.bmw.carit.jnario.ui.contentassist.antlr.internal.InternalJnarioParser typedParser = (de.bmw.carit.jnario.ui.contentassist.antlr.internal.InternalJnarioParser) parser;
			typedParser.entryRuleJnario();
