		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJnarioAccess().getImportsAssignment_0(), "rule__Jnario__ImportsAssignment_0");
					put(grammarAccess.getJnarioAccess().getNameAssignment_1(), "rule__Jnario__NameAssignment_1");
					put(grammarAccess.getJnarioAccess().getBackgroundAssignment_2(), "rule__Jnario__BackgroundAssignment_2");
					put(grammarAccess.getJnarioAccess().getScenariosAssignment_3(), "rule__Jnario__ScenariosAssignment_3");
