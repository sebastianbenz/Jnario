...
public class JnarioParser extends AbstractContentAssistParser {
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJnarioFileAccess().getGroup(), "rule__JnarioFile__Group__0");
					put(grammarAccess.getJnarioFileAccess().getGroup_1(), "rule__JnarioFile__Group_1__0");
					...
					put(grammarAccess.getJnarioFileAccess().getPackageAssignment_1_1(), "rule__JnarioFile__PackageAssignment_1_1");
					put(grammarAccess.getJnarioFileAccess().getImportsAssignment_2(), "rule__JnarioFile__ImportsAssignment_2");
					put(grammarAccess.getJnarioFileAccess().getXtendClassAssignment_3(), "rule__JnarioFile__XtendClassAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			...
			typedParser.entryRuleJnarioFile();
