...
* generated by Xtext
*/
package de.bmw.carit.jnario.ui.refactoring;
 ...
 */
public class JnarioRenameStrategy extends AbstractJvmModelRenameStrategy {
	...
	public static class Provider extends DefaultRenameStrategy.Provider {
		...
		public IRenameStrategy get(EObject targetElement, IRenameElementContext renameElementContext) {
			return new JnarioRenameStrategy(targetElement, getLocationInFileProvider(), jvmModelAssociations);
		}
	}
	
	protected JnarioRenameStrategy(EObject targetElement, ILocationInFileProvider locationInFileProvider,
