...
public class WorldSpec {
  ...
  @Mock
  WorldVisitor worldVisitor;
  
  AliveCell anAliveCell = new Function0<AliveCell>() {
  ...
  AliveCell anotherAliveCell = new Function0<AliveCell>() {
    public AliveCell apply() {
      AliveCell _aliveCell = AliveCell.aliveCell();
      return _aliveCell;
    }
  ...
  DeadCell aDeadCell = new Function0<DeadCell>() {
