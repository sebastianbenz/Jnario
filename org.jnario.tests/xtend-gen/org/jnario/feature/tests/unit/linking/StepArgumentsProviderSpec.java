...
public class StepArgumentsProviderSpec {
  ...
  public void _initStepArgumentsProviderSpecExamples() {
    ...
    List<Object> _list = CollectionLiterals.<Object>list();
    List<Object> _list_1 = CollectionLiterals.<Object>list();
    List<String> _list_2 = CollectionLiterals.<String>list("hello");
    List<String> _list_3 = CollectionLiterals.<String>list("hello", "world");
    List<String> _list_4 = CollectionLiterals.<String>list("hello", "world");
    List<String> _list_5 = CollectionLiterals.<String>list("hello");
    List<Object> _list_6 = CollectionLiterals.<Object>list();examples = ExampleTable.create("examples", 
