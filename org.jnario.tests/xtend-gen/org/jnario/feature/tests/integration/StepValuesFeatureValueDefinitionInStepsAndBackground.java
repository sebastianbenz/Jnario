...
import org.jnario.feature.tests.integration.StepValuesFeatureBackground;
...
@Named("Scenario: Value definition in steps and Background")
@SuppressWarnings("all")
public class StepValuesFeatureValueDefinitionInStepsAndBackground extends StepValuesFeatureBackground {
  @Test
  @Order(0)
