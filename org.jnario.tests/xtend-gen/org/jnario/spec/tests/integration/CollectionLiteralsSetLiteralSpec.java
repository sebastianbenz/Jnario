...
public class CollectionLiteralsSetLiteralSpec extends CollectionLiteralsSpec {
  ...
  public void setGreenRedNewHashSetGreenRed() throws Exception {
    Set<String> _set = CollectionLiterals.<String>set("green", "red");
    HashSet<String> _newHashSet = org.eclipse.xtext.xbase.lib.CollectionLiterals.<String>newHashSet("green", "red");
  ...
  public void setSetGreenSetRedNewHashSetNewHashSetGreenNewHashSetRed() throws Exception {
    Set<String> _set = CollectionLiterals.<String>set("green");
    Set<String> _set_1 = CollectionLiterals.<String>set("red");
    Set<Set<String>> _set_2 = CollectionLiterals.<Set<String>>set(_set, _set_1);
    HashSet<String> _newHashSet = org.eclipse.xtext.xbase.lib.CollectionLiterals.<String>newHashSet("green");
    HashSet<String> _newHashSet_1 = org.eclipse.xtext.xbase.lib.CollectionLiterals.<String>newHashSet("red");
    HashSet<HashSet<String>> _newHashSet_2 = org.eclipse.xtext.xbase.lib.CollectionLiterals.<HashSet<String>>newHashSet(_newHashSet, _newHashSet_1);
