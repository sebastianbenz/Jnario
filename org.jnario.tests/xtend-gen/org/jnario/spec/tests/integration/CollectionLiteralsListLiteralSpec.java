...
public class CollectionLiteralsListLiteralSpec extends CollectionLiteralsSpec {
  ...
  public void listGreenRedNewArrayListGreenRed() throws Exception {
    List<String> _list = CollectionLiterals.<String>list("green", "red");
    ArrayList<String> _newArrayList = org.eclipse.xtext.xbase.lib.CollectionLiterals.<String>newArrayList("green", "red");
  ...
  public void listListGreenListRedNewArrayListNewArrayListGreenNewArrayListRed() throws Exception {
    List<String> _list = CollectionLiterals.<String>list("green");
    List<String> _list_1 = CollectionLiterals.<String>list("red");
    List<List<String>> _list_2 = CollectionLiterals.<List<String>>list(_list, _list_1);
    ArrayList<String> _newArrayList = org.eclipse.xtext.xbase.lib.CollectionLiterals.<String>newArrayList("green");
    ArrayList<String> _newArrayList_1 = org.eclipse.xtext.xbase.lib.CollectionLiterals.<String>newArrayList("red");
    ArrayList<ArrayList<String>> _newArrayList_2 = org.eclipse.xtext.xbase.lib.CollectionLiterals.<ArrayList<String>>newArrayList(_newArrayList, _newArrayList_1);
