...
public class ExampleNameProviderToJavaClassNameExampleTableSpec extends ExampleNameProviderSpec {
  ...
  @Order(99)
  public void shouldCombineExampleAndParentName() throws Exception {
    ...
    boolean _doubleArrow = Should.operator_doubleArrow(_exampleTableClassName, "MyContextSpecMyExample");Assert
  ...
  @Order(99)
  public void shouldConvertExampleNameToFirstUpper() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("describe \'My Context\'{");
    _builder.newLine();
    _builder.append("  ");
