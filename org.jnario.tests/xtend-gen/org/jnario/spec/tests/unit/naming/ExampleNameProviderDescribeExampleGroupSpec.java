...
public class ExampleNameProviderDescribeExampleGroupSpec extends ExampleNameProviderSpec {
  ...
  public void shouldUseTheDescription() throws Exception {
    ...
    boolean _should_be = Should.should_be(_describeFirst, "My Description");Assert
  ...
  public void shouldUseTheTargetType() throws Exception {
    ...
    boolean _should_be = Should.should_be(_describeFirst, "Assert");Assert
  ...
  public void shouldCombineTargetTypeAndDescription() throws Exception {
    ...
    boolean _should_be = Should.should_be(_describeFirst, "Assert and more");Assert
  ...
  public void shouldUseTheTargetOperation() throws Exception {
    ...
    boolean _should_be = Should.should_be(_describeSecond, "assertTrue[boolean]");Assert
  ...
  public void shouldCombineTargetOperationAndDescription() throws Exception {
    ...
    boolean _should_be = Should.should_be(_describeSecond, "assertTrue[boolean] and more");Assert
  ...
  public void shouldEscapeQuotes() throws Exception {
    ...
    boolean _should_be = Should.should_be(_describeSecond, "and \\\"more\\\"");Assert
