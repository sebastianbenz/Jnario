...
public class JnarioSpecsTutorialHowToWriteASpecificationSpec extends JnarioSpecsTutorialSpec {
  ...
  @Order(0)
  public void checkingYourFacts() throws Exception {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("val subject = new Stack");
    _builder.newLine();
    _builder.append("    ");
  ...
  @Order(1)
  public void lessBoilerplate() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package demo");
    _builder.newLine();
    _builder.newLine();
  ...
  @Named("Using Fields")
  @Order(2)
  public void usingFields() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package demo");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("Stack subject = new Stack");
    _builder.newLine();
    _builder.append("  ");
  ...
  @Order(3)
  public void implicitSubjects() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package demo");
    _builder.newLine();
    _builder.newLine();
  ...
  @Order(4)
  public void definingContexts() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package demo");
    _builder.newLine();
    _builder.append("\t      ");
  ...
  @Order(6)
  public void generatingDocumentation() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package demo");
    _builder.newLine();
    _builder.append("\t\t\t\t      ");
  ...
  @Order(7)
  public void setupTeardown() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
  ...
  @Order(8)
  public void specExtensions() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
