...
@Named("Spec")
@Contains({ OperationNameProviderSpec.class, UsingJUnitRulesSpec.class, ExampleGroupSpec.class, AnnotationsSpec.class, CollectionLiteralsSpec.class, BeforeSpec.class, UsingXtendSWithOperatorSpec.class, SpecScopeProviderSpec.class, UsingShouldSpec.class, ImplicitSubjectSpec.class, JnarioSpecsTutorialSpec.class, AfterSpec.class, SimpleExampleSpec.class, ExtensionsSpec.class, ThrowsSpec.class, SpecQualifiedNameProviderSpec.class, SpecsExampleTablesSpec.class, AssertionSpec.class, BeforeAllSpec.class, SpecDocGeneratorSpec.class, PendingSpec.class, SpecInstantiationSpec.class, StaticImportsSpec.class, AfterAllSpec.class, ExampleNameProviderSpec.class, ExampleSpec.class, SpecJavaValidatorSpec.class })
