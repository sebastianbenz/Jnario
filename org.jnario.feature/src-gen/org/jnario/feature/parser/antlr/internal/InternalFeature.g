...
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureFileAccess().getImportsImportParserRuleCall_2_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureFileAccess().getXtendClassFeatureParserRuleCall_3_0()); 
	    }
...
ruleDESCRIPTION returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    ...
    @after { leaveRule(); }:
(    this_IN_ORDER_TEXT_0=RULE_IN_ORDER_TEXT    {
		$current.merge(this_IN_ORDER_TEXT_0);
    }

    { 
    newLeafNode(this_IN_ORDER_TEXT_0, grammarAccess.getDESCRIPTIONAccess().getIN_ORDER_TEXTTerminalRuleCall_0()); 
    }
    this_AS_A_TEXT_1=RULE_AS_A_TEXT    {
		$current.merge(this_AS_A_TEXT_1);
    }

    { 
    newLeafNode(this_AS_A_TEXT_1, grammarAccess.getDESCRIPTIONAccess().getAS_A_TEXTTerminalRuleCall_1()); 
    }
    this_I_WANT_TEXT_2=RULE_I_WANT_TEXT    {
		$current.merge(this_I_WANT_TEXT_2);
    }

    { 
    newLeafNode(this_I_WANT_TEXT_2, grammarAccess.getDESCRIPTIONAccess().getI_WANT_TEXTTerminalRuleCall_2()); 
    }
)
    ;
...
(
		{ 
	        newCompositeNode(grammarAccess.getBackgroundAccess().getStepsGivenParserRuleCall_3_0_0()); 
	    }
		lv_steps_3_1=ruleGiven		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getBackgroundRule());
	        }
       		add(
    ...
    |		{ 
	        newCompositeNode(grammarAccess.getBackgroundAccess().getStepsGivenReferenceParserRuleCall_3_0_1()); 
	    }
		lv_steps_3_2=ruleGivenReference		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getBackgroundRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getScenarioAccess().getStepsGivenParserRuleCall_3_0_0()); 
	    }
		lv_steps_3_1=ruleGiven		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getScenarioRule());
    ...
    |		{ 
	        newCompositeNode(grammarAccess.getScenarioAccess().getStepsGivenReferenceParserRuleCall_3_0_1()); 
	    }
		lv_steps_3_2=ruleGivenReference		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getScenarioRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getScenarioAccess().getStepsThenParserRuleCall_5_0_0()); 
	    }
		lv_steps_5_1=ruleThen		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getScenarioRule());
	        }
       		add(
    ...
    |		{ 
	        newCompositeNode(grammarAccess.getScenarioAccess().getStepsThenReferenceParserRuleCall_5_0_1()); 
	    }
		lv_steps_5_2=ruleThenReference		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getScenarioRule());
	        }
       		add(
...
(
		...
		lv_examples_6_0=ruleExampleTable		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getScenarioRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getBlockExpressionAccess().getExpressionsXExpressionInsideBlockParserRuleCall_0_0()); 
	    }
...
entryRuleExampleTable returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getExampleTableRule()); }
	 iv_ruleExampleTable=ruleExampleTable 
	 { $current=$iv_ruleExampleTable.current; } 
	 EOF 
;

// Rule ExampleTable
ruleExampleTable returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		lv_name_0_0=RULE_EXAMPLE_TEXT
		{
			newLeafNode(lv_name_0_0, grammarAccess.getExampleTableAccess().getNameEXAMPLE_TEXTTerminalRuleCall_0_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getExampleTableRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"name",
...
(
		lv_explicitSyntax_3_0=RULE_PIPE
		{
			newLeafNode(lv_explicitSyntax_3_0, grammarAccess.getMatcherClosureAccess().getExplicitSyntaxPIPETerminalRuleCall_2_0_1_0()); 
		}
		{
	        if ($current==null) {
