...
public class StepReferenceFieldCreator {
  ...
  public Set<String> getExistingFieldNamesForContainerOfStepReference(final StepReference ref) {
    ...
    boolean _notEquals = ObjectExtensions.operator_notEquals(refScenario, null);
    if (_notEquals) {
      ...
      boolean _notEquals_1 = ObjectExtensions.operator_notEquals(refBackground, null);
      if (_notEquals_1) {
  ...
  public Set<String> getExistingFieldNames(final EList<XtendMember> members) {
    Iterable<XtendField> _filter = IterableExtensions.<XtendField>filter(members, XtendField.class);
  ...
  public EList<XtendMember> getMembersOfReferencedStep(final Step step) {
    EList<XtendMember> _xblockexpression = null;
    {
      ...
      boolean _notEquals = ObjectExtensions.operator_notEquals(scenario, null);
      if (_notEquals) {
      ...
      if ((member instanceof XtendField)) {
        ...
        if (_not) {
          ...
          if ((objectWithReference instanceof Scenario)) {
            ...
            CollectionExtensions.<XtendField>operator_add(_members, copiedMember);
          }
          if ((objectWithReference instanceof Background)) {
            ...
            CollectionExtensions.<XtendField>operator_add(_members_1, copiedMember);
          }
