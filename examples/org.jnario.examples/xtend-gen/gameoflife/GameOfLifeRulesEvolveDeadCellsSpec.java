...
public class GameOfLifeRulesEvolveDeadCellsSpec extends GameOfLifeRulesSpec {
  ...
  @Test
  @Named("deadcells.forEach[ subject.becomesAlive[liveNeighbourCount] => becomesAlive ]")
  @Order(99)
  public void _deadcellsForEachSubjectBecomesAliveLiveNeighbourCountBecomesAlive() throws Exception {
    final Procedure1<GameOfLifeRulesEvolveDeadCellsSpecDeadcells> _function = new Procedure1<GameOfLifeRulesEvolveDeadCellsSpecDeadcells>() {
        public void apply(final GameOfLifeRulesEvolveDeadCellsSpecDeadcells it) {
          boolean _becomesAlive = GameOfLifeRulesEvolveDeadCellsSpec.this.subject.becomesAlive(it.liveNeighbourCount);
