...
public class SuiteStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.jnario.org/suite/Suite")) {
		EPackage.Registry.INSTANCE.put("http://www.jnario.org/suite/Suite", org.jnario.suite.suite.SuitePackage.eINSTANCE);
	}
