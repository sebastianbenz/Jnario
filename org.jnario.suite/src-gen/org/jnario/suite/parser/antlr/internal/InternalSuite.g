...
entryRuleSuiteFile returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSuiteFileRule()); }
	 iv_ruleSuiteFile=ruleSuiteFile 
	 { $current=$iv_ruleSuiteFile.current; } 
	 EOF 
;

// Rule SuiteFile
ruleSuiteFile returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
		{ 
	        newCompositeNode(grammarAccess.getSuiteFileAccess().getImportsImportParserRuleCall_2_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getSuiteFileAccess().getXtendClassesSuiteParserRuleCall_3_0()); 
	    }
		lv_xtendClasses_5_0=ruleSuite		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSuiteFileRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getSuiteAccess().getSpecsReferenceParserRuleCall_3_0()); 
	    }
		lv_specs_3_0=ruleReference		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSuiteRule());
	        }
       		add(
...
entryRulePatternReference returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPatternReferenceRule()); }
	 iv_rulePatternReference=rulePatternReference 
	 { $current=$iv_rulePatternReference.current; } 
	 EOF 
;

// Rule PatternReference
rulePatternReference returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
(
		lv_pattern_0_0=RULE_PATTERN
		{
...
entryRuleSpecReference returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSpecReferenceRule()); }
	 iv_ruleSpecReference=ruleSpecReference 
	 { $current=$iv_ruleSpecReference.current; } 
	 EOF 
;

// Rule SpecReference
ruleSpecReference returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
