		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFeatureFileAccess().getImportsAssignment_2(), "rule__FeatureFile__ImportsAssignment_2");
					put(grammarAccess.getFeatureFileAccess().getXtendClassAssignment_3(), "rule__FeatureFile__XtendClassAssignment_3");
					...
					put(grammarAccess.getGivenReferenceAccess().getAndAssignment_2(), "rule__GivenReference__AndAssignment_2");
					put(grammarAccess.getGivenAccess().getNameAssignment_1(), "rule__Given__NameAssignment_1");
					put(grammarAccess.getGivenAccess().getStepExpressionAssignment_2(), "rule__Given__StepExpressionAssignment_2");
					put(grammarAccess.getGivenAccess().getAndAssignment_3(), "rule__Given__AndAssignment_3");
					put(grammarAccess.getWhenReferenceAccess().getReferenceAssignment_1(), "rule__WhenReference__ReferenceAssignment_1");
					put(grammarAccess.getWhenReferenceAccess().getAndAssignment_2(), "rule__WhenReference__AndAssignment_2");
					put(grammarAccess.getWhenAccess().getNameAssignment_1(), "rule__When__NameAssignment_1");
					put(grammarAccess.getWhenAccess().getStepExpressionAssignment_2(), "rule__When__StepExpressionAssignment_2");
					put(grammarAccess.getWhenAccess().getAndAssignment_3(), "rule__When__AndAssignment_3");
					put(grammarAccess.getThenReferenceAccess().getReferenceAssignment_1(), "rule__ThenReference__ReferenceAssignment_1");
					put(grammarAccess.getThenReferenceAccess().getAndAssignment_2(), "rule__ThenReference__AndAssignment_2");
					put(grammarAccess.getThenAccess().getNameAssignment_1(), "rule__Then__NameAssignment_1");
					put(grammarAccess.getThenAccess().getStepExpressionAssignment_2(), "rule__Then__StepExpressionAssignment_2");
					put(grammarAccess.getThenAccess().getAndAssignment_3(), "rule__Then__AndAssignment_3");
					...
					put(grammarAccess.getAndAccess().getStepExpressionAssignment_2(), "rule__And__StepExpressionAssignment_2");
