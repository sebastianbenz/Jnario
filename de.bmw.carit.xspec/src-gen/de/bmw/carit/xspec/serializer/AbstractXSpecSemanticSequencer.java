...
public class AbstractXSpecSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected XSpecGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == TypesPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
		...
		else if(semanticObject.eClass().getEPackage() == XspecPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XspecPackage.XSPEC:
				if(context == grammarAccess.getXSpecRule()) {
					sequence_XSpec_XSpec(context, (XSpec) semanticObject); 
					return; 
				}
				else break;
			}
	...
	protected void sequence_Sentence_Sentence(EObject context, Sentence semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, XspecPackage.Literals.SENTENCE__GIVEN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XspecPackage.Literals.SENTENCE__GIVEN));
			if(transientValues.isValueTransient(semanticObject, XspecPackage.Literals.SENTENCE__WHEN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XspecPackage.Literals.SENTENCE__WHEN));
			if(transientValues.isValueTransient(semanticObject, XspecPackage.Literals.SENTENCE__THEN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XspecPackage.Literals.SENTENCE__THEN));
		}
	...
	/**
	 * Constraint:
	 *     (moduleName=ID specs+=Sentence*)
	 *
	 * Features:
	 *    moduleName[1, 1]
	 *    specs[0, *]
	 */
	protected void sequence_XSpec_XSpec(EObject context, XSpec semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
