...
package de.bmw.carit.xspec.services;
...
@Singleton
public class XSpecGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class XSpecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "XSpec");
		...
		private final RuleCall cSpecsSentenceParserRuleCall_2_0 = (RuleCall)cSpecsAssignment_2.eContents().get(0);
		...
		//Sentence
		public RuleCall getSpecsSentenceParserRuleCall_2_0() { return cSpecsSentenceParserRuleCall_2_0; }
	...
	@Inject
	public XSpecGrammarAccess(GrammarProvider grammarProvider,
	...
	//XSpec:
	//	moduleName=ID "{" specs+=Sentence* "}";
	public XSpecElements getXSpecAccess() {
		return (pXSpec != null) ? pXSpec : (pXSpec = new XSpecElements());
	}
	
	public ParserRule getXSpecRule() {
		return getXSpecAccess().getRule();
	}
