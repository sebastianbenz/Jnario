...
@Named("Specs")
@Contains({ DefiningXtendClassesInYourSpecsSpec.class, ImplicitSubjectSpec.class, SpecExtensionsSpec.class, UsingJUnitRulesInSpecsSpec.class, UsingTablesSpec.class })
