...
public class SuiteDocGeneratorSpec {
  ...
  public void _generatesSuiteDocWithResolvedSpecs() throws Exception {
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("<li><a class=\"specref notrun\" href=\"../test/RedSpec.html\">Red</a></li>");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("<li><a class=\"specref notrun\" href=\"../test/BlueSpec.html\">Blue</a>: with a description</li>");
    _builder_1.newLine();
    _builder_1.append("</ul>");
    _builder_1.newLine();
    _builder_1.append("<span id=\"Subheading\" class=\"suite notrun\"><h2>Subheading</h2></span>");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("<li><a class=\"specref notrun\" href=\"../test/GreenSpec.html\">Green</a></li>");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("<li><a class=\"specref notrun\" href=\"../test/GreySpec.html\">Grey</a></li>");
    _builder_1.newLine();
    _builder_1.append("</ul>");
    _builder_1.newLine();
