...
@Named("Feature")
@Contains({ FeatureCompilerSpec.class, FeatureClassNameProviderSpec.class, FeatureDocGeneratorSpec.class, FeatureExecutableProviderSpec.class, FeatureJavaValidatorSpec.class, FeatureLocationInFileProviderSpec.class, FeatureQualifiedNameProviderSpec.class, FeatureValueConverterSpec.class, GivenWhenThenSpec.class, IntroducingJnarioFeaturesSpec.class, ReferencingOtherStepsSpec.class, SetupTeardownWithFeatureExtensionsFeature.class, ShouldSpec.class, StepArgumentsProviderSpec.class, StepContextProviderSpec.class, StepNameProviderSpec.class, StepTypeProviderSpec.class })
