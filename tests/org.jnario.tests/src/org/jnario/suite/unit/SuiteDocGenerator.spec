...
describe SuiteDocGenerator {
	...
	fact "Generates suite doc with resolved specs"{
		...
		val expected = '''
			...
			<ul>
				<li><a class="" href="../test/RedSpec.html">Red</a></li>
				<li><a class="" href="../test/BlueSpec.html">Blue</a>: with a description</li>
			</ul>
			<span id="Subheading" class=""><h2>Subheading</h2></span>
			<p>Subheading description with <strong>markdown</strong>.</p>
			<ul>
				<li><a class="" href="../test/GreenSpec.html">Green</a></li>
				<li><a class="" href="../test/GreySpec.html">Grey</a></li>
			</ul>
		'''.toString
