 ...
 * <ul>
 *   <li>{@link de.bmw.carit.jnario.spec.spec.After#isAfterAll <em>After All</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.bmw.carit.jnario.spec.spec.SpecPackage#getAfter()
 * @model
 * @generated
 */
public interface After extends TestFunction
{
	 ...
	 * @see de.bmw.carit.jnario.spec.spec.SpecPackage#getAfter_AfterAll()
	 * @model default="false"
	 * @generated
	 */
	boolean isAfterAll();
	...
	/**
	 * Sets the value of the '{@link de.bmw.carit.jnario.spec.spec.After#isAfterAll <em>After All</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
