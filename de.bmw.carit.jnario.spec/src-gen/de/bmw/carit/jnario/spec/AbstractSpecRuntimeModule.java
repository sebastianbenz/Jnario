...
/**
 * Manual modifications go to {de.bmw.carit.jnario.spec.SpecRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractSpecRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/bmw/carit/jnario/spec/Spec.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.bmw.carit.jnario.spec.Spec");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return de.bmw.carit.jnario.spec.services.SpecGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return de.bmw.carit.jnario.spec.serializer.AbstractSpecSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return de.bmw.carit.jnario.spec.serializer.AbstractSpecSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return de.bmw.carit.jnario.spec.parser.antlr.SpecParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return de.bmw.carit.jnario.spec.parser.antlr.SpecAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return de.bmw.carit.jnario.spec.parser.antlr.internal.InternalSpecLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<de.bmw.carit.jnario.spec.parser.antlr.internal.InternalSpecLexer> provideInternalSpecLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(de.bmw.carit.jnario.spec.parser.antlr.internal.InternalSpecLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(de.bmw.carit.jnario.spec.parser.antlr.internal.InternalSpecLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends de.bmw.carit.jnario.spec.validation.SpecJavaValidator> bindSpecJavaValidator() {
		return de.bmw.carit.jnario.spec.validation.SpecJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return de.bmw.carit.jnario.spec.formatting.SpecFormatter.class;
	}
