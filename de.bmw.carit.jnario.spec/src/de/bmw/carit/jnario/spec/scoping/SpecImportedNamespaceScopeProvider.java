 ...
 */
public class SpecImportedNamespaceScopeProvider extends XbaseImportedNamespaceScopeProvider {
	...
	protected List<ImportNormalizer> internalGetImportedNamespaceResolvers(EObject context, boolean ignoreCase) {
		if (!(context instanceof SpecFile))
			return Collections.emptyList();
		SpecFile file = (SpecFile) context;
		...
		if (!Strings.isEmpty(((SpecFile) context).getPackageName())) {
			importedNamespaceResolvers.add(new ImportNormalizer(nameConverter.toQualifiedName(((SpecFile) context)
