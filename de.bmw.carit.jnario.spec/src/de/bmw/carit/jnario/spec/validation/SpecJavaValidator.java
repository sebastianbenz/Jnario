...
import static org.eclipse.xtext.xtend2.validation.IssueCodes.ANNOTATION_WRONG_TARGET;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.CLASS_EXPECTED;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.CLASS_MUST_BE_ABSTRACT;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.CONSTRUCTOR_TYPE_PARAMS_NOT_SUPPORTED;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.CYCLIC_INHERITANCE;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.DISPATCH_FUNCTIONS_MIXED_STATIC_AND_NON_STATIC;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.DISPATCH_FUNCTIONS_NON_STATIC_EXPECTED;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.DISPATCH_FUNCTIONS_STATIC_EXPECTED;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.DISPATCH_FUNCTIONS_WITH_DIFFERENT_VISIBILITY;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.DUPLICATE_FIELD;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.DUPLICATE_METHOD;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.DUPLICATE_PARAMETER_NAME;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.EXCEPTION_DECLARED_TWICE;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.EXCEPTION_NOT_THROWABLE;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.FIELD_LOCALLY_NEVER_READ;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.FUNCTION_LOCALLY_NEVER_USED;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.INCOMPATIBLE_THROWS_CLAUSE;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.INTERFACE_EXPECTED;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.INVALID_USE_OF_STATIC;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.MISSING_CONSTRUCTOR;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.MISSING_OVERRIDE;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.MUST_INVOKE_SUPER_CONSTRUCTOR;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.OBSOLETE_OVERRIDE;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.OVERRIDDEN_FINAL;
import static org.eclipse.xtext.xtend2.validation.IssueCodes.OVERRIDE_REDUCES_VISIBILITY;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.CREATE_EXTENSION_INFO__NAME;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_CLASS__EXTENDS;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_CLASS__IMPLEMENTS;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_CLASS__NAME;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_CONSTRUCTOR__PARAMETERS;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FIELD__NAME;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FIELD__TYPE;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__DISPATCH;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__EXCEPTIONS;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__NAME;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__OVERRIDE;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__PARAMETERS;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__RETURN_TYPE;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__STATIC;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_FUNCTION__VISIBILITY;
import static org.eclipse.xtext.xtend2.xtend2.Xtend2Package.Literals.XTEND_PARAMETER__NAME;
